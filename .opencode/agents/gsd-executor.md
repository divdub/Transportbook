...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `/Users/girdharisahu/Projects/TransportApp/.opencode/mcp.json`, so a
...
@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/ios-scaffold.md
...
@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/templates/summary.md
