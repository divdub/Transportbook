...
**Verification depth scales with `asvs_level`** (see @/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
