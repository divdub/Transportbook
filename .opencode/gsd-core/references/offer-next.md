...
Read and follow `/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
