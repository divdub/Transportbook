...
- Usage: Reference from command with `@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/girdharisahu/Projects/TransportApp/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/girdharisahu/Projects/TransportApp/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
