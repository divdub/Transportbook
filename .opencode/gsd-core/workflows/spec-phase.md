...
ones). Reference: @/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/girdharisahu/Projects/TransportApp/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/girdharisahu/Projects/TransportApp/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/templates/spec.md.
