...
- **Global scope**: `/Users/girdharisahu/Projects/TransportApp/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/girdharisahu/Projects/TransportApp/.opencode/notes/`)
...
2. Glob `/Users/girdharisahu/Projects/TransportApp/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/girdharisahu/Projects/TransportApp/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/girdharisahu/Projects/TransportApp/.opencode/notes/` — works in any directory
