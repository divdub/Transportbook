...
```markdown
Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/girdharisahu/Projects/TransportApp/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/girdharisahu/Projects/TransportApp/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
