...
<required_reading>
@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/ai-frameworks.md
@/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-eval-planner.md for instructions.
