...
```
Agent(
  prompt="Read /Users/girdharisahu/Projects/TransportApp/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/templates/VALIDATION.md`
