...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/girdharisahu/Projects/TransportApp/.opencode/.gsd-surface.json`
(sibling to `/Users/girdharisahu/Projects/TransportApp/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/girdharisahu/Projects/TransportApp/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/girdharisahu/Projects/TransportApp/.opencode/skills`).
...
`/Users/girdharisahu/Projects/TransportApp/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/girdharisahu/Projects/TransportApp/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/girdharisahu/Projects/TransportApp/.opencode/.gsd-surface.json`
Install profile marker: `/Users/girdharisahu/Projects/TransportApp/.opencode/.gsd-profile`
Skill dirs: `/Users/girdharisahu/Projects/TransportApp/.opencode/skills/gsd-*/`
Engine module: `/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/girdharisahu/Projects/TransportApp/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
