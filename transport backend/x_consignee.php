...
$tblname = "m_x_consignee";
$tblpkey = "xconsignee_id";
$pagename = "x_consignee.php";
$modulename = "X-Consignee Master";
$duplicate='';
...
if(isset($_GET['editid']) != "")
{
	...
	$row = mysqli_fetch_array($sql);
	 $xconsignee_name = $row['xconsignee_name']; 
	$mobile_no  = $row['mobile_no'];
	$email_id=$row['email_id'];
	$xconsignee_address	=$row['xconsignee_address'];
...
{
	  $xconsignee_name = $_POST['xconsignee_name'];
	 $mobile_no =$_POST['mobile_no'];
	 $email_id =$_POST['email_id'];
	 $xconsignee_address =$_POST['xconsignee_address'];
	...
	$form_data = array('xconsignee_name'=>$xconsignee_name,'mobile_no'=>$mobile_no,'email_id'=>$email_id,'xconsignee_address'=>$xconsignee_address,'place_id'=>$place_id,'gst_no'=>$gst_no,'pan_no'=>$pan_no,'opn_balnc'=>$opn_balnc,'opn_balnc_date'=>$opn_balnc_date,'acc_holder_name'=>$acc_holder_name,'acc_no'=>$acc_no,'ifsc_code'=>$ifsc_code,'bank_name'=>$bank_name,'branch_name'=>$branch_name,'acc_type'=>$acc_type,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"xconsignee_name='$xconsignee_name'");
		if($count == 0)
		{
...
<head>
	...
	<title>X-Consignee Master :: Chaaruvi Infotech Pvt. Ltd.</title>
...
<body>
				...
				<div class="row">
					<div class="box box-bordered box-color">
							<div class="box-title">
								...
								<h3>
									<i class="fa fa-bars"></i>X-Consignee Master</h3>							
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">X-Consignee  Name <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="xconsignee_name" id="xconsignee_name" placeholder="Enter Name" class="form-control" value="<?php echo $xconsignee_name; ?>" required>
												</div>
											</div>
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="number" name="mobile_no" id="mobile_no" placeholder="Contact No." class="form-control" 
													oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" value="<?php echo $mobile_no; ?>" required>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="xconsignee_address" id="xconsignee_address" placeholder="X-Consignee Address" class="form-control" value="<?php echo $xconsignee_address; ?>" required>
												</div>
											</div>
	...
	<div class="col-sm-4">
											...
											<select name="ctype" id="ctype" class='form-control'>
											    ...
											    <script>document.getElementById('ctype').value = '<?php echo $ctype; ?>';</script>
												</div>
											</div>
			...
			<h3>	<i class="fa fa-table"></i>
					X-Consignee Master Details</h3>
				<a href="pdf/pdf_m_x_consignee.php" class="btn" style="float: right" target="_blank">Pdf 
											<i class="fa fa-file-pdf-o"></i>
										</a> &nbsp;
					<a href="excel/excel_xconsignee.php" class="btn btn-warning" style="float: right">Excel
			...
			<div class="box-content nopadding">
				...
				$place_name=$cmn->getvalfield($connection,"m_place","place_name","place_id=$row[place_id]");
					...
					<tr>
						<td><?php echo $sn++; ?></td>
						<td><?php echo $row['xconsignee_name']; ?></td>
			...
			<a href="?editid=<?php echo $row['xconsignee_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
							  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['xconsignee_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>
							  	<?php } ?>	</td>
					</tr>
					<?php } ?>	
					</tbody>
