				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color satblue">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Service / Maintenance Report
								  </h3>
							</div>
							...
							<div class="box box-color box-bordered red">
								<div class="box-title">
									<h3> <i class="fa fa-table"></i>
										Service / Maintenance Detail List</h3>
									...
									<a href="excel/excel_service.php?fromdate=<?php echo $fromdate ?>&todate=<?php echo $todate; ?>&vehicle_id=<?php echo $vehicle_id ?>&head_id=<?php echo $head_id ?>&mechanic_id=<?php echo $mechanic_id ?>" class="btn btn-warning" style="float: right">Excel
										...
										//echo "sselect * from service_entry  $crit  && comp_id=$comp_id && session_id='$session_id' order by service_id desc";
											...
											?>
												<tr>
													...
													<!--<td><a class="btn btn-warning" href="pdfservice.php?service_id=<?php echo ucfirst($row['service_id']); ?>" target="_blank">Print</a></td>-->
													<td class='hidden-480'>

														<a href="maintance-process.php?service_id=<?php echo $row['service_id']; ?>" class="btn btn-inverse" rel="tooltip" title="Edit">
