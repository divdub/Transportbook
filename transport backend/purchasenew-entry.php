...
if (isset($_POST['submit'])) {
   ...
   if ($purchaseid == '') {
   	...
   	mysqli_query($connection,"INSERT into purchaseentry set purchase_date='$purchase_date',supplier_id='$supplier_id',bill_type='$bill_type', billno='$billno',compid='$compid',remark='$remark',purchase_type='$purchase_type',sessionid='$sessionid',createdby='$createdby',ipaddress='$ipaddress',createdate='$createdate'");

      $action = 1;
      $process = "insert";
      $keyvalue = mysqli_insert_id($connection);
      
    mysqli_query($connection, "update purchasentry_detail set purchaseid='$keyvalue' where purchaseid='0' && compid='$compid' && sessionid='$sessionid'");
	mysqli_query($connection,"update purchaseorderserial set purchaseid='$keyvalue' where purchaseid='0' && compid='$compid' && session_id='$sessionid'");
//   $totalamt = $cmn->gettotalpurchase($connection, $keyvalue);
   ...
   mysqli_query($connection,"update purchaseentry set is_paid='1' where purchaseid='$keyvalue'");
       ...
       mysqli_query($connection,"update purchaseentry set purchase_date='$purchase_date',supplier_id='$supplier_id',bill_type='$bill_type', billno='$billno',remark='$remark',purchase_type='$purchase_type',sessionid='$sessionid',createdby='$createdby',ipaddress='$ipaddress',lastupdated='$lastupdated' WHERE $tblpkey = '$keyvalue'");
      $action = 2;
      $process = "updated";
...
<body onLoad="showrecord('<?php echo $keyvalue; ?>');">
						...
						<div class="box box-bordered box-color satblue">
							...
							while ($row1 = mysqli_fetch_array($sql1)) { 
								...
								?>
									...
									<?php } ?>
									<li>
										<a id="purchasereport" data-toggle='tab' style="background: #fab750; color: #000000">
											<i class="fa fa-share"></i>Purchase Report</a>
									</li>
										<li>
										<a id="salereport" data-toggle='tab' style="background: #fab750; color: #000000">
	...
	<div class="col-sm-3">	
																<div class="form-group" >
																	...
																	<div class="col-sm-8" >
																	<select name="supplier_id" id="supplier_id" class="select2-me" style="width:100%;">
                                  ...
                                  <script>
                                       document.getElementById('bill_type').value ='challan';
                                           ...
                                           <script>document.getElementById('remark').value = '<?php echo $remark ; ?>'; </script>
																	</div>
																</div>
