				...
				<i class="fa fa-file-excel-o"></i></a>
						...
						$sql = mysqli_query($connection,"Select * from  $tblname  order by $tblpkey desc");
										...
										<tr>
											...
											<a href="?editid=<?php echo $row['unit_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
											  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['unit_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>	<?php } ?>
										</tr>
						<?php } ?>
									</tbody>
								</table>
