...
$pdf->SetX(10);
$pdf->Cell(45, 8, 'Total Income  :', 2, 0, 'L');


$pdf->SetX(55);
$pdf->Cell(90, 8, ucwords(convert_number_to_words($total_incamount)) . " Rupees Only", 2, 1, 'L');
$pdf->SetX(10);
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->SetX(55);
$pdf->Cell(90, 8, ucwords(convert_number_to_words($totbalamt)) . " Rupees Only", 2, 1, 'L');
