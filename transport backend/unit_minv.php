...
if(isset($_POST['submit']))
{
	...
	$form_data = array('unit_name'=>$unit_name,'created_date'=>$currentdate); 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"unit_name='$unit_name'");
		if($count == 0)
		{
	...
	{
	$form_data = array('unit_name'=>$unit_name,'updated_date'=>$currentdate);
...
<head>
	...
	<title>UNIT MASTER  :: CHAARUVI INFOTEH PVT. LTD.</title>
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Unit Master </h3>
							</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Unit Name <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="unit_name" id="unit_name" placeholder="Unit Name" class="form-control" value="<?php echo $unit_name; ?>" required>
												</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="fa fa-table"></i>Unit Details</h3>
				...
				<i class="fa fa-file-excel-o"></i></a>
						...
						$sql = mysqli_query($connection,"Select * from  $tblname  order by $tblpkey desc");
										...
										<tr>
											...
											<a href="?editid=<?php echo $row['unitinv_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
											  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['unitinv_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>	<?php } ?>
										</tr>
						<?php } ?>
									</tbody>
								</table>
