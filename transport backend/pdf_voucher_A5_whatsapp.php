...
$keyvalue="";
	...
	$voucher_no = $_REQUEST['billid'];
		$pay_receive_id = $_REQUEST['pay_receive_id'];
	$sql = mysqli_query($connection,"select * from $tblname where voucher_no='$voucher_no' && category='$category' && pay_receive_id='$pay_receive_id' && comp_id=$comp_id && session_id=$session_id && consignorid='$consignorid'");
...
$paid_to=$cmn->getvalfield($connection,"payment","payee_name","voucher_id='$row[voucher_no]' && consignorid='$consignorid' && comp_id=$comp_id && session_id=$session_id ");
 $vamt=$cmn->getvalfield($connection,"payment","sum(amt_paid_to)","voucher_id='$row[voucher_no]' && comp_id=$comp_id && session_id=$session_id && consignorid='$consignorid'"); 
 $receive_amt=$row['receive_amt'];
$rcamt=$cmn->getvalfield($connection,"payment_receive","sum(receive_amt)","voucher_no='$row[voucher_no]' && comp_id=$comp_id && session_id=$session_id && consignorid='$consignorid'"); 
$balamt= $vamt - $rcamt;
$filename = 'whatsapp/'.$pay_receive_id.'.pdf';
...
$acc_holder_name=$cmn->getvalfield($connection, "m_company", "acc_holder_name", "comp_id=$_SESSION[comp_id]");
    $acc_no1=$cmn->getvalfield($connection, "m_company", "acc_no", "comp_id=$_SESSION[comp_id]"); 
    $ifsc_code1=$cmn->getvalfield($connection, "m_company", "ifsc_code", "comp_id=$_SESSION[comp_id]");
    $bank_name=$cmn->getvalfield($connection, "m_company", "bank_name", "comp_id=$_SESSION[comp_id]");
