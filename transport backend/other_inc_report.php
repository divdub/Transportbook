...
<body>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color satblue">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i> Other Income Report
								  </h3>
							</div>
  ...
  <div class="col-sm-3">
	...
	<script>document.getElementById('payment_mode').value = '<?php echo $payment_mode; ?>';</script>
			...
			<a href="pdf/pdf_othr_inc.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&otherid=<?php echo $otherid; ?>&payment_mode=<?php echo $payment_mode; ?>" class="btn" style="float: right" target="_blank">Pdf 
											<i class="fa fa-file-pdf-o"></i>
										</a> &nbsp;
					<a href="excel/excel_othr_inc.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&otherid=<?php echo $otherid; ?>&payment_mode=<?php echo $payment_mode; ?>" class="btn btn-warning" style="float: right">Excel
			...
			<div class="box-content nopadding">
				<table class="table table-hover table-nomargin table-striped table-bordered dataTable dataTable-colvis">
					...
					<th>S.No</th>
						...
						<th class='hidden-480'>Action</th> <?php } ?>
					</tr>
					</thead>
					<tbody>
...
// $driver_name=$cmn->getvalfield($connection,"m_driver","driver_name","driver_id=$row[driver_id]");
		...
		<!--<a href="?editid=<?php echo $row['other_inc_id']; ?>" class="btn btn-inverse" rel="tooltip" title="Edit">-->
		<!--	<i class="fa fa-edit"></i>-->
		<!--</a>-->
		<a href="<?php echo $pagename ?>" onClick="funDel(<?php echo $row['other_inc_id']; ?>)" class="btn btn-danger" rel="tooltip" title="Delete">
