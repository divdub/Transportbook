...
if(isset($_POST['submit']))
{
	...
	$form_data = array('catname'=>$catname,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"catname='$catname'");
		if($count == 0)
		{
	...
	{
	$form_data = array('catname'=>$catname,'updated_date'=>$currentdate);
...
<head>
	...
	<title>Document  MASTER :: CHAARUVI INFOTECH PVT. LTD.</title>
 ...
 <div class="row" style="padding-top:20px;">
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Document Master</h3>
							</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Document Name</label>
												<div class="col-sm-8">
													<input type="text" name="catname" id="catname" placeholder="Enter Document  Name" class="form-control" value="<?php echo $catname; ?>" required>
												</div>
											</div>
	...
	<div class="row">
		...
		<!--					<i class="fa fa-file-excel-o"></i></a>						-->
			...
			<a href="?editid=<?php echo $row['doccat_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
						  <!--<a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['doccat_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a> -->
						  <?php } ?>	
