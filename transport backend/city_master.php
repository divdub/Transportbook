...
if(isset($_POST['submit']))
{
	...
	$form_data = array('place_name'=>$place_name,'state_id'=>$state_id,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"place_name='$place_name' && state_id='$state_id'");
		if($count == 0)
		{
	...
	{
	$form_data = array('place_name'=>$place_name,'state_id'=>$state_id,'updated_date'=>$currentdate);
...
<head>
	...
	<title>PLACE MASTER :: CHAARUVI INFOTECH PVT. LTD.</title>
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Place Master</h3>
							</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="place_name" id="place_name" placeholder="Place Name" class="form-control" value="<?php echo $place_name; ?>" required>
												</div>
											</div>
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4"> State <span style="color: red">*</span></label>
												<div class="col-sm-8">
												<select name="state_id" id="state_id" class='select2-me' style="width:350px;" required>
										...
										<tr>
											...
											<td class='hidden-350'>
											    <?php if ($user_type == 'admin') { ?>
													<a href="?editid=<?php echo $row['place_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
