<?php 
   ...
   $tblname = "tpa_entry";
   $tblpkey = "tpa_id";
   $pagename = "consignee_paid_unpaid_report.php";
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="box box-bordered box-color satblue">
                        <div class="box-title">
                           <h3>
                              <i class="fa fa-list"></i>Consignee Paid / Unpaid Report
                           </h3>
                        </div>
               ...
               <div class="box box-color box-bordered red" style="overflow:scroll;">
                           <div class="box-title">
                             ...
                             Consignee Paid / Unpaid List
                              ...
                              <!--</a> &nbsp;-->
                              <!--<a href="excel/excel_dispatch_entry.php?fromdate=<?php echo $fromdate ?>&todate=<?php echo $todate ?>&selectype=<?php echo $selectype ?>&item_id=<?php echo $item_id ?>" class="btn btn-warning" style="float: right">Excel-->
                           ...
                           <div class="box-content nopadding">
                              <table class="table table-hover table-nomargin table-striped table-bordered dataTable dataTable-colvis">
                                 ...
                                 <tbody>
                                       ...
                                       <?php
                                          $sn=1;
                                        //   echo		"Select * from  $tblname  $crit && consignorid=$consignorid && tpcat_id=2 order by $tblpkey desc";
                                          $sql = mysqli_query($connection,"Select * from  $tblname  $crit && consignorid=$consignorid && tpcat_id=2 order by $tblpkey desc");
                                          	  while($row= mysqli_fetch_array($sql)) {
								...
								$payee_name = $cmn->getvalfield($connection,"payment","payee_name","voucher_id='$voucher_id' && consignorid=$consignorid");
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $row['rate']; ?></td>
                                         <td><?php echo number_format($wt_mt * $row['rate'],2);?></td>
                                        
                   <td><?php echo $voucher_id;?></td>
				   <td><?php echo $status;?></td> <td><?php echo dateformatindia($paydate);?></td>  <td><?php echo $payee_name;?></td> 
