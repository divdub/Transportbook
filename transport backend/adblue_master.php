...
$tblname = "m_adblue";
$tblpkey = "adblue_id";
$pagename = "adblue_master.php";
$modulename = "AdBlue  Master";
$duplicate='';
...
{
	  $adblue_name = $_POST['adblue_name'];
	$form_data = array('adblue_name'=>$adblue_name,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"adblue_name='$adblue_name'");
		if($count == 0)
		{
	...
	{
		$form_data = array('adblue_name'=>$adblue_name,'updated_date'=>$currentdate);
...
<body>
  ...
  <div class="row" style="padding-top:20px;">
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>AdBlue  Master</h3>
							</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">AdBlue Name <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="adblue_name" id="adblue_name" placeholder="AdBlue Name" value="<?php echo $adblue_name;?>" class="form-control" required>
												</div>
											</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="fa fa-table"></i>AdBlue  Master Details</h3>
	...
	<!--			<i class="fa fa-file-excel-o"></i></a>-->
						...
						<a href="?editid=<?php echo $row['adblue_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
					  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['adblue_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>		<?php } ?>
										</tr>
										<?php } ?>
									</tbody>
								</table>
