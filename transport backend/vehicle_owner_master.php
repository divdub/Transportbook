...
$tblpkey = "owner_id";
$pagename = "vehicle_owner_master.php";
$modulename = "Vehicle Owner Master";
$duplicate='';
...
if(isset($_GET['editid']) != "")
{
	...
	$gst_no=$row['gst_no'];
	$pan_no=$row['pan_no'];
	$upload_declaration=$row['upload_declaration'];
...
if(isset($_POST['submit']))
{
	...
	$gst_no = $_POST['gst_no'];
	$pan_no = $_POST['pan_no'];
	$upload_declaration = $_FILES['upload_declaration'];
	...
	$form_data = array('owner_name'=>$owner_name,'other_name'=>$other_name,'email_id'=>$email_id,'mobileno1'=>$mobileno1,'mobileno2'=>$mobileno2,'owner_type'=>$owner_type,'oaddress'=>$oaddress,'place_id'=>$place_id,'tds'=>$tds,'gst_no'=>$gst_no,'pan_no'=>$pan_no,'opn_balnc'=>$opn_balnc,'opn_balnc_date'=>$opn_balnc_date,'acc_holder_name'=>$acc_holder_name,'acc_no'=>$acc_no,'ifsc_code'=>$ifsc_code,'bank_name'=>$bank_name,'branch_name'=>$branch_name,'acc_type'=>$acc_type,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
	$count = check_duplicate($connection,$tblname,"owner_name='$owner_name' && other_name='$other_name'");
		if($count == 0)
		{
			dbRowInsert($connection,$tblname, $form_data);
	       $lastownerid = $connection->insert_id;
			  $imgpath2="upload/declaration/";
			  
            	$uploaded_filename1 = uploadImage($imgpath2,$upload_declaration); 
            	"update $tblname set upload_declaration='$uploaded_filename1' where $tblpkey='$lastownerid'";
            mysqli_query($connection,"update $tblname set upload_declaration='$uploaded_filename1' where $tblpkey='$lastownerid'");
    ...
    if($_FILES['upload_declaration']['tmp_name']!="")
				{
	             ...
	             $rowimg = mysqli_fetch_array($sql);
					...
					$oldimg = $rowimg["upload_declaration"]; 
					if($oldimg != ""){
					unlink("upload/declaration/$oldimg");
				}
				 $imgpath="upload/declaration/";
					//insert new file
				$uploaded_filename = uploadImage($imgpath,$upload_declaration);
				
					mysqli_query($connection,"update $tblname set upload_declaration='$uploaded_filename' where $tblpkey='$keyvalue'");
				}
...
<head>
	...
	<title>Vehicle Owner Master</title>
		...
		<div id="main">
	       ...
	       <div class="row" style="padding-top:20px;">
              ...
              <?php } ?>
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Vehicle Owner Master</h3>
							</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Vehicle Owner Name <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="owner_name" id="owner_name" placeholder="Enter Owner Name" value="<?php echo $owner_name; ?>" class="form-control" required>
												</div>
											</div>
                                   ...
                                   <div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="number" name="mobileno1" id="mobileno1" placeholder="Contact No." oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" class="form-control" value="<?php echo $mobileno1; ?>"required>
												</div>
											</div>
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4"> Owner Type <span style="color: red">*</span></label>
												<div class="col-sm-8">
				...
				<script>document.getElementById('owner_type').value = '<?php echo $owner_type; ?>';</script>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="oaddress" class="control-label col-sm-4">Address <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="oaddress" id="oaddress" placeholder="Owner Address" class="form-control" value="<?php echo $oaddress; ?>" required>
												</div>
											</div>
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">City <span style="color: red">*</span></label>
												<div class="col-sm-8">
                                                <select name="place_id" id="place_id" class='select2-me' required style="width:342px;">
					...
					<script>document.getElementById('place_id').value = '<?php echo $place_id; ?>';</script>
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4"> TDS ? <span style="color: red">*</span></label>
												<div class="col-sm-8">
                                                <select name="tds" id="tds" class='form-control' required>
                                                <option value="">Select</option>	
												<option value="1">Yes</option>
												<option value="2">No</option>	
											</select>
				    <script>document.getElementById('tds').value = '<?php echo $tds; ?>';</script>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="gst_no" id="gst_no" placeholder="Gst No." class="form-control" maxlength="15" value="<?php echo $gst_no; ?>">
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Upload Declaration</label>
												<div class="col-sm-8">
													<input type="file" name="upload_declaration" id="upload_declaration" value="<?php echo $upload_declaration; ?>" placeholder="Text input" class="form-control">
														<?php if($upload_declaration!=''){ ?>		<span><img style="width: 80px; height: 80px;border-radius: 10px;border: 2px solid black;" src="upload/declaration/<?php echo $upload_declaration ?>" alt="<?php echo $upload_declaration; ?>" /></span><?php } ?>
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="acc_no" id="acc_no" placeholder="Account No." maxlength="16" class="form-control" value="<?php echo $acc_no; ?>">
												</div>
											</div>
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="ifsc_code" id="ifsc_code" placeholder="IFSC Code" maxlength="15"
						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3>
									...
									Vehicle Owner Master Details
								</h3>
								<a href="pdf/pdf_m_vehicle_owner.php" class="btn" style="float: right" target="_blank">Pdf 
											<i class="fa fa-file-pdf-o"></i>
										</a> &nbsp;
					<a href="excel/excel_vehicle_owner.php" class="btn btn-warning" style="float: right">Excel
						...
						$sql = mysqli_query($connection,"Select * from  $tblname  order by $tblpkey desc");
										...
										<tr>
                                           ...
                                           <td><?php echo $row['owner_type']; ?></td>
                                           	<td><b><a href="upload/declaration/<?php echo $row['upload_declaration'] ?>" class="text-danger"  target="_blank" download>Download</a></b></td>
											<td class='hidden-350'> <?php if ($user_type == 'admin') { ?>
									<a href="?editid=<?php echo $row['owner_id']; ?>" class="btn btn-primary "rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
							  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['owner_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>
							  	<?php } ?></td>
										</tr>
									<?php } ?>
									</tbody>
