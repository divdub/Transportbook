				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color satblue">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Bilty Commission Report</h3>
							</div>
	...
	<!-- 									<div class="col-sm-3">
		...
		<!-- 		
			...
			<div class="box-content nopadding"  style="overflow:scroll;">
				...
				$sql = mysqli_query($connection,"Select * from  $tblname  $crit  && bilty_commision!=0  && consignorid=$consignorid order by $tblpkey desc");
										  while($row= mysqli_fetch_array($sql)) {
