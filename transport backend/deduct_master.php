...
$tblname = "m_deduct";
$tblpkey = "deduct_id";
$pagename ="deduct_master.php";
$modulename = "Deduct Master";
$duplicate='';
...
<head>
	...
	<title>Extra MASTER  :: CHAARUVI INFOTEH PVT. LTD.</title>
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Extra Master </h3>
							</div>
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <label for="textfield" class="control-label col-sm-4">Extra Name <span style="color: red">*</span></label>
                <div class="col-sm-8">
                    <input type="text" name="deduct_name" id="deduct_name" placeholder="Extra Name" class="form-control" value="<?php echo $deduct_name; ?>" required>
                </div>
            </div>
        </div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3><i class="fa fa-table"></i>Extra Details</h3>
