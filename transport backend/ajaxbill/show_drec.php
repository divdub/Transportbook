...
<div class="box-content nopadding">
          ...
          $sql=mysqli_query($connection,"select * from  other_deduct where invoiceid='0' && session_id='$session_id' && consignorid= '$consignorid'");
                                ...
                                <tr>
                                     <td><?php echo $sn++;?></td>
												...
												<td><?php echo $row['dremark'];?></td>
									 			...
									 			<td>
												 <a class="btn btn-danger" onClick="funDel1(<?php echo $row['deduct_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>
