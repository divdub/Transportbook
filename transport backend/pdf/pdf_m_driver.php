...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "DRIVER DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(40, 7, 'DRIVER NAME ', 1, 0, 'L', 1);
        $this->Cell(20, 7, 'MOBILE NO.', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'ADDRESS', 1, 0, 'L', 1);
         $this->Cell(50, 7, 'BASIC SALARY', 1, 0, 'L', 1);
        $this->Cell(40, 7, 'LICENCE EXPIRY DATE', 1, 1, 'L', 1);
...
$slno = 1;
$sql = mysqli_query($connection, "select * from m_driver");
while ($row_get = mysqli_fetch_array($sql)) {
    // $pdf->SetX(5);
    $lic_exp_date=dateformatindia($row_get['lic_exp_date']);
    $pdf->Row(array($slno++, $row_get['driver_name'], $row_get['mobile_no'],$row_get['daddress'],$row_get['salary'],$lic_exp_date));
}
$pdf->Output();
?> 
