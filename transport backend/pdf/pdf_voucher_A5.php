...
$keyvalue="";
	...
	$sql = mysqli_query($connection,"select * from $tblname where voucher_no='$voucher_no' && category='$category' && pay_receive_id=$pay_receive_id && comp_id=$comp_id && session_id=$session_id");
