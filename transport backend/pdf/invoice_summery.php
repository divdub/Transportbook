...
$pdf->SetFont('courier','b',9);
	...
	$pdf->SetFont('Arial','UB',10);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(40,4,"PAN NO : $companypan",'0',1,'C',0);
	$pdf->Ln(2);
	
	// $pdf->setX(200);
	$pdf->SetFont('Arial','UB',10);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(50,4,"GST NO: $companygst",'0',1,'C',0);
	$pdf->Ln(1);
...
$pdf->Image('../upload/logo/'.$c_logo,6,6,18,11);
	...
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(40,4,"INV NO :",'0',0,'R',0);
	$pdf->Cell(80,4,"$invno",'0',1,'L',0);
	$pdf->Ln(2);
		$pdf->setX(200);
	$pdf->SetFont('Arial','',11);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(40,4,"INV DATE :",'0',0,'R',0);
	...
	$pdf->Cell(20,6,'Sno','1',0,'L',1); 
  	// $pdf->Cell(17,6,'DI NO ',1,0,'L',1);
          	$pdf->Cell(167,6,'PARTICULARS','1',0,'C',1);   
	...
	$pdf->Cell(30,6,'QTY (MT)',1,0,'C',1);
	$pdf->Cell(30,6,'RATE (MT)',1,0,'C',1);
	$pdf->Cell(40,6,'AMOUNT',1,1,'C',1);
...
// 	$pdf->Cell(10,6,'MT',1,1,'L',1);
	...
	$pdf->SetWidths(array(20,160,30,30,30,30));
...
$pdf->Cell(185,7,'Total No Of Invoices: '.$sn,'0',1,'L',1);
	...
	if($gsttype=="gst"){
	$pdf->setX(5);
		$pdf->Cell(187,6,'ADD '.number_format($gst/2).'% CGST ','1','0','R',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(40,6,number_format($tot_gst/2,2),'1','1','L',0);
    $pdf->setX(5);
		$pdf->Cell(187,6,'ADD '.number_format($gst/2).'% SGST ','1','0','R',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(40,6,number_format($tot_gst/2,2),'1','1','L',0);
...
$pdf->setX(5);
	...
	$pdf->Cell(187,6,'ADD '.$gst.'% IGST ','1','0','R',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(40,6,number_format($tot_gst,2),'1','1','L',0);

    }
    $pdf->setX(5);
    $pdf->Cell(187,6,'GST TOTAL','1','0','R',0);
   $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(40,6,number_format($tot_gst,2),'1','1','L',0);
	$pdf->setX(5);
	...
	$pdf->Cell(187,6,"TOTAL INVOICE VALUE ",'1',0,'R',0);
      $pdf->Cell(30,6,'','1',0,'L',0);
    $pdf->Cell(30,6,'','1',0,'L',0);
	$pdf->Cell(40,6,number_format($nettotal_amt +$tot_gst,2),'1','1','L',0);
