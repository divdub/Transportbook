...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
     $this->ln(6);
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "SESSION DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(16, 7, 'Sno', '1', 0, 'L', 1);
        $this->Cell(55, 7, 'Start Date', 1, 0, 'L', 1);
        $this->Cell(58, 7, 'End Date  ', 1, 0, 'L', 1);
        $this->Cell(62, 7, 'Session Name .', 1, 1, 'L', 1);



        $this->SetWidths(array(16, 55, 58, 62));
...
$sql = mysqli_query($connection, "select * from m_session");
while ($row_get = mysqli_fetch_array($sql)) {


  $session_start=  dateformatindia($row_get['session_start']);
  $session_end=  dateformatindia($row_get['session_end']);


    // $pdf->SetX(5);
    $pdf->Row(array($slno++, $session_start, $session_end, $row_get['session_name']));
}
$pdf->Output();
?> 
