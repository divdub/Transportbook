...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
       ...
       $this->Cell(90);
    $this->Cell(10, 13,strtoupper($caddress), 0, 0, 'C');
      $this->Ln(0);
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "PURCHASE DETAILS", 0, 1, 'C');
        $this->Ln(5);
        $this->SetFont('courier', 'b', 11);
        $this->Cell(90);
        ...
        $this->SetFillColor(135, 206, 235); //gray
        $this->SetTextColor(0, 0, 0);
        $this->Cell(8, 7, 'Sno', '1', 0, 'L', 1);
        $this->Cell(20, 7, 'Date', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'Supplier Name', 1, 0, 'L', 1);
        $this->Cell(25, 7, 'Bill No', 1, 0, 'L', 1);
        $this->Cell(35, 7, 'Bill Type', 1, 0, 'L', 1);
         $this->Cell(20, 7, 'Qty', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'Remark', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'Net Total', 1, 1, 'L', 1);
        $this->SetX(6);
        $this->SetWidths(array(8, 20, 30,25,35,20,30,30));
...
$date = dateformatindia($row['purchase_date']);
...
$bill_no = ucfirst($row['billno']);
$remark = ucfirst($row['remark']);
$pdf->SetX(6);
$pdf->Row(array($slno++,$date, $supplier_name, $bill_no,$bill_type,$qty,$remark,$total_amt));
 }
$pdf->Output();
?> 
