...
include("../fpdf17/rotation.php");
 ...
 if(isset($_GET['voucher_id']))
  {
    $voucher_no = trim(addslashes($_GET['voucher_id']));
  }
  else
  $voucher_no = '';
  ...
  //   }
    ...
    $cond .=" and voucher_id='$voucher_no'";
    }
      if($catname !='') {
    
    $cond .=" and catname='$catname'";
    }
...
$c_logo = $cmn->getvalfield($connection,"m_company","clogo","comp_id='$_SESSION[comp_id]'");
 ...
 $consignor_name = $cmn->getvalfield($connection,"m_consignor","consignor_name","consignor_id=$consignorid"); 


$curr_openingbal = $payment - $payment_receive ;
$rc_amt=$cmn->getvalfield($connection,"payment_receive","sum(receive_amt)","voucher_no='$voucher_no' && comp_id=$comp_id && session_id=$session_id && consignorid=$consignorid"); 
if($rc_amt==''){
    $rcamt=0;
} else {
     $rcamt=$rc_amt;
}
$bankid=$cmn->getvalfield($connection,"payment_receive","bankid","voucher_no='$voucher_no' && comp_id=$comp_id && session_id=$session_id && consignorid=$consignorid");
...
$utrno=$cmn->getvalfield($connection,"payment_receive","utrno","voucher_no='$voucher_no' && comp_id=$comp_id && session_id=$session_id && consignorid=$consignorid");
 ...
 $pdf->SetX(20);
    ...
    $mobile_no=$onwer['mobileno1'];
                                       $pdf->Image('../upload/logo/'.$c_logo,10,3,20);
                                        ...
                                        $pdf->Cell(150,8,'',2,0,'C');
                                        
                                        $pdf->Ln();

                                        $pdf->SetX(50);
                                         $pdf->SetFont('Times','',10);
                                        $pdf->Cell(260,6,$onwer['caddress'],2,0,'C');
                                        $pdf->Ln();
                                           ...
                                           $lh = 100;
                                            ...
                                            $pdf->Line(2, 20, 293,20);
                                             ...
                                             $pdf->SetX(2.5);
                                               ...
                                               $pdf->Cell(291,7,$consignor_name.' Voucher (Bill  Details)',0,0,'C','F');
                                        ...
                                        $pdf->SetFillColor(211, 211, 211);
                                            ...
                                            $pdf->SetFont('Arial','B',8);
                                                    $pdf->Cell(6,8,'S.N',1,0,'C','F');
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(18,8,'DI/LR No',1,0,'L','F');
                                                     
                                                      
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(16,8,'Bilty Date',1,0,'R','F');
                                                     
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(18,8,'Item',1,0,'R','F');

                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(20,8,'Truck No',1,0,'R','F');

                                                     $pdf->SetFont('Arial','B',8);
                                                   //  $pdf->Cell(30,8,'Destination',1,0,'L');
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(40,8,'Destination',1,0,'L','F');
                                                     
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,8,'Wt',1,0,'R','F');
                                                     $pdf->SetFont('Arial','B',7);
                                                     $pdf->Cell(10,8,'Rec.wt',1,0,'R','F');
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,8,'Sh.wt',1,0,'R','F');
                                                    ...
                                                    //  $pdf->Cell(13,8,'Commi.',1,0,'R');
                                                     ...
                                                     $pdf->Cell(10,8,'Rate',1,0,'L','F');
                                                      ...
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'Frt Amt',1,0,'R','F');

                                                    $pdf->SetFont('Arial','B',7);
                                                     $pdf->Cell(10,8,"Comm",1,0,'R','F');

                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,8,'Bank',1,0,'R','F');
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'Rebid',1,0,'C','F');
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(11,8,'Shrt',1,0,'R','F');
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'TDS',1,0,'R','F');

                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'Di Adv',1,0,'C','F');
                                                     
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,8,'Cash Adv',1,0,'C','F');
                                                     
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(8,8,'GPS ',1,0,'C','F');
                                                          $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,8,'Extra Hold',1,0,'C','F');
                                                    //      $pdf->SetFont('Arial','B',8);
                                                    //  $pdf->Cell(18,8,'Consignee',1,0,'C');
                                                    
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(17,8,' Net Amt',1,1,'R','F');
                                                    


     
                    // echo  "SELECT * from payment  $cond ";    
                      $sn=1;  
                   $sel = "SELECT * from payment  $cond && consignorid=$consignorid && comp_id=$comp_id && session_id=$session_id";
...
$rec_wt=$cmn->getvalfield($connection,"dispatch_entry","rec_wt","dispatch_id='$row[dispatch_id]'");
$destination=$cmn->getvalfield($connection,"m_place","place_name","place_id='$destination_id'");
...
$item_name=$cmn->getvalfield($connection,"m_item","item_name","item_id='$item_id'");
 ...
 $bilty_commision=$row['bilty_commision'];
 $sortamt=$row['sortamt'];
  $tds=$row['tds'];
 $tds_amt=$row['tds_amt']; 
 $rebidcharge=$row['rebidcharge']; 
...
$deduct=$row['deduct'];
      ...
      $pdf->SetX(2);
                                                    $pdf->Cell(6,8, $sn++,1,0,'L');
                                                     ...
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(18,8,$di_no,1,0,'L');
                                                     
                                                    
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(16,8,date('d-m-Y',strtotime($bilty_date)),1,0,'R');
                                                     
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(18,8,$item_name,1,0,'R');

                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(20,8,$vehicle_no,1,0,'R');

                                                     $pdf->SetFont('Arial','',8);
                                                   //  $pdf->Cell(30,8,$toplace,1,0,'L');
                                                     
                                                      $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(40,8,$destination,1,0,'C');
                                                     
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(10,8, $wt_mt,1,0,'R');

                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(10,8,$rec_wt,1,0,'R');

                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(10,8,$wt_mt - $rec_wt,1,0,'R');
                                                    ...
                                                    $pdf->Cell(10,8,round($freight_rate),1,0,'R');
                                                     ...
                                                     $pdf->Cell(12,8,round($freight_amt),1,0,'R');
                                                     $pdf->SetFont('Arial','',8);

                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(10,8,round($bilty_commision),1,0,'R');
                                                     $pdf->SetFont('Arial','',8);
                                                      $pdf->SetTextColor(255, 0, 0);
                                                     $pdf->Cell(10,8,$bank_charge,1,0,'R');
                                                     $pdf->SetFont('Arial','',8);
                                                   
                                                    $pdf->Cell(12,8,$rebidcharge,1,0,'R');
                                                     
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(11,8,$sortamt,1,0,'R');
                                                    ...
                                                    $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(12,8,'-'.round($tds_amt),1,0,'R');
 $pdf->SetTextColor(0, 0, 0);
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(12,8,round($diesel_adv_amt),1,0,'R');
                                                      $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(15,8,round($cash_adv),1,0,'R');
                                                      $pdf->SetFont('Arial','',8);
                                                $pdf->Cell(8,8,round($other_cash_adv),1,0,'R');
                                                    ...
                                                    $pdf->Cell(17,8,number_format(round($amt_paid_to),2),1,0,'R');
...
$balamt= $great_total - $rcamt ;
                                        ...
                                        $pdf->SetX(2);
                                                     $pdf->SetFont('Arial','B',9);
                                                     $pdf->Cell(118,12,'Total',1,0,'C');

                                                     
                                                     
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,12, $total_wt_mt,1,0,'R');
                                                     $pdf->SetFont('Arial','B',8);
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,12,'',1,0,'R');
                                                      ...
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,12,round($total_freight),1,0,'R');
                                                     

                                                  $pdf->SetFont('Arial','B',8);
                                             $pdf->Cell(10,12,round($total_commision),1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                         $pdf->SetTextColor(255, 0, 0);
                                                     $pdf->Cell(10,12,$total_bank_charge,1,0,'R');
                                                     $pdf->Cell(12,12,$total_rebidcharge,1,0,'R');
                                                     $pdf->SetFont('Arial','B',8);
                                                     
                                                     $pdf->Cell(11,12,$total_deduct,1,0,'R');

//  $pdf->SetTextColor(0, 0, 0);
                                                    $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,12,'-'.round($total_tds),1,0,'R');
                                                     $pdf->SetTextColor(0, 0, 0);
                                                    ...
                                                    //  $pdf->Cell(8,12,'',1,0,'R');
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,12,round($total_desial_adv),1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,12,round($total_adv),1,0,'R');
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(17,12,number_format(round($great_total),2),1,0,'R');
                                                     ...
                                                     $pdf->SetX(2);
                                                      $pdf->SetFont('Arial','B',10);
                                                      $pdf->SetFillColor(175, 213, 240);
                                                     $pdf->Cell(148,12,'Grant Total Amount',1,0,'C','F');

                                                     
                                                     $pdf->Cell(144,12,number_format(round($great_total),2),1,1,'R','F');
...
//   $pdf->Cell(155,10,UCWORDS(getinwordsbyindia($great_total)),2,0,'L');
      ...
      $pdf->Ln(5);
                                                    ...
                                                    //  $pdf->Ln(5);
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(10);      $pdf->Cell(45,5,'Name of A/c Holder   ',2,0,'L');

                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(50,5,ucwords($acc_holder_name),2,0,'L');
                                           
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(105);      $pdf->Cell(45,5,' ',2,0,'L');
                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(145);     $pdf->Cell(50,5,'',2,0,'L');
                                                     
                                              $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(185);      $pdf->Cell(45,5,'',2,1,'L');
                                                    
                                                     $pdf->SetFont('Arial','',10);       $pdf->SetX(10);      $pdf->Cell(45,5,'Account No.   ',2,0,'L');
                                                     $pdf->SetFont('Arial','B',10);
                                                     
                                                     $pdf->SetX(55);     $pdf->Cell(50,5,ucwords($acc_no1),2,0,'L');
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(105);      $pdf->Cell(45,5,'',2,0,'L');
                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(145);     $pdf->Cell(50,5,'',2,0,'L');
                                                     ...
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(185);      $pdf->Cell(45,5,'',2,1,'L');
                                                     $pdf->SetFont('Arial','',10);       $pdf->SetX(10);      $pdf->Cell(45,5,'IFSC Code  ',2,0,'L');
                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(50,5,ucwords($ifsc_code1),2,0,'L');
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(105);      $pdf->Cell(45,5,'',2,0,'L');
                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(145);     $pdf->Cell(50,5,'',2,0,'L');
                                                     ...
                                                     $pdf->SetX(185);      $pdf->Cell(45,5,'',2,1,'L');
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(10);      $pdf->Cell(45,5,'Bank Name  ',2,0,'L');

                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(50,5,ucwords($bank_name),2,1,'L');
                                               
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(10);      $pdf->Cell(45,5,'Branch Name  ',2,0,'L');

                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(50,5,ucwords($branch_name),2,1,'L');
                                                     $pdf->SetFont('Arial','',10);
                                                     $pdf->SetX(10);      $pdf->Cell(45,5,'UTR / Refrence No  ',2,0,'L');

                                                     $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(50,5,$utrno,2,1,'L');
                                                     ...
                                                     $pdf->SetX(10);        $pdf->Cell(45,8,'Amount Paid :',2,0,'L');

                                                     if($amt_paid != '0'){
                                                     $pdf->SetX(55);     $pdf->Cell(90,8,ucwords(getinwordsbyindia($rcamt))." Only",2,1,'L');
                                                      } else {
                                                        $pdf->SetX(55);     $pdf->Cell(90,8,"",2,1,'L');

                                                      } 
                                                       
                                                       
                                                      $pdf->SetX(10);      $pdf->Cell(45,8,'Balance Payable  :',2,0,'L');

                                                      $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(90,8,ucwords(getinwordsbyindia(round($balamt),2))." Only",2,1,'L');                                               
