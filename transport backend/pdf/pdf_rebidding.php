...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "Rebidding Charge Report", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(45, 7, 'CONSIGNEE NAME', 1, 0, 'C', 1);
        $this->Cell(30, 7, 'DESTINATION', 1, 0, 'C', 1);
        $this->Cell(10, 7, 'WT', 1, 0, 'C', 1);
        $this->Cell(10, 7, 'QTY', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'REBIDDING CHARGE', 1,1 , 'L', 1);
        // $this->Cell(26, 7, 'CONSIGNEE ADV', 1, 1, 'L', 1);
        // $this->Cell(18, 7, 'COMP RATE', 1, 1, 'L', 1);

        $this->SetWidths(array(10, 15,20,20,45,30,10,10,30,26));
        $this->SetAligns(array("L", "L", "C","C","L","L","C","C","C","L"));
    }
    // Page footer
    function Footer()
    {
...
$pdf->AddPage('P', 'A4');
	...
	$sn=1;
				...
				$sql = mysqli_query($connection,"Select * from  payment  $crit  && rebidcharge!=0  && consignorid=$consignorid ");
    ...
    $pdf->Row(array($sn++, $di_no,$bilty_date,$vehicle_no,$consignee_name,$place_name,$wt_mt,$qty,$row['rebidcharge']));
}
 $pdf->SetFillColor(170, 170, 170); //gray
        $pdf->SetTextColor(0, 0, 0);
        $pdf->Cell(160, 7, 'TOTAL', '1', 0, 'C', 1);
        $pdf->Cell(30, 7, $trebidcharge, 1, 0, 'L', 1);
$pdf->Output();
?> 
