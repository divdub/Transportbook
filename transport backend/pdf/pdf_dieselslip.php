...
$owner_id = $cmn->getvalfield($connection, "m_vehicle", "owner_id", "vehicle_id ='$row[vehicle_id]'");
 $supplier_name = $cmn->getvalfield($connection, "m_petrol_pump", "pump_name", "pump_id ='$row[pump_id]'");
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(180,4,ucwords($supplier_name),'0',1,'C',0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(180,7,'Diesel Issue Slip','0',1,'C',0);
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(22,4,'To Place','0',0,'L',0);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->Cell(18,4,'Driver Mob.','0',0,'L',0);
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->Cell(187,6,'Payment Mode' ,1,1,'C',0);
...
$pdf->Cell(37,6,'Rs '.number_format($diesel_adv_amt,2),1,1,'R',0);
...
$pdf->Cell(37,6,'Rs '.number_format($totalamt,2),1,1,'R',0);
...
$pdf->Cell(180,4,ucwords($supplier_name),'0',1,'C',0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(180,6,'Diesel Issue Slip','0',1,'C',0);
...
$pdf->Cell(10,5,'Created by- '.$user,0,0,'L',0);
