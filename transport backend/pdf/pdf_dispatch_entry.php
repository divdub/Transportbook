...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 1, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "DISPATCH ENTRY DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(25, 7, 'TRUCK NO.', 1, 0, 'L', 1);
        $this->Cell(20, 7, 'DESTINATION', 1, 0, 'R', 1);
        $this->Cell(15, 7, 'ITEM', 1, 0, 'L', 1);
        $this->Cell(10, 7, 'WT/MT', 1,0 , 'L', 1);
        $this->Cell(8, 7, 'QTY', 1, 0, 'L', 1);
        $this->Cell(18, 7, 'COMP RATE', 1, 1, 'L', 1);

        $this->SetWidths(array(8, 15,18,30,30,25,20,15,10,8,18));
...
$item_name=$cmn->getvalfield($connection,"m_item","item_name","item_id=$row_get[item_id]");         
    ...
    $pdf->SetX(6);
    $pdf->Row(array($slno++, $row_get['di_no'],$bilty_date,$consignor_name,$consignee_name,$vehicle_no,$destination,$item_name,$row_get['wt_mt'],$row_get['qty'],$row_get['comp_rate']));
