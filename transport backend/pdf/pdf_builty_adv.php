...
$pan_card = $cmn->getvalfield($connection,"m_company","pan_no","comp_id='$_SESSION[comp_id]'");
if($dispatch_id !='')
{
   ...
   $chalan=$row['bilty_no'];
    ...
    $consigneemo = $cmn->getvalfield($connection,"m_consignee","mobile_no","consignee_id='$consigneeid'"); 
...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
    ...
    function Header()
    {       
        global $title1,$title2,$companygst,$headaddress,$phoneno,$mobileno1,$mobileno2,$caddress,$cname,$di_no,$gr_date,$gr_no,$bilty_date,$invoiceno,$distance,$deliverat,$consigneename,$consignorname,$truckno,$placename,$destination,$totalweight,$own_rate,$itemname,$pan_card,$clogo,$consigneemo;
...
//$this->Image('bpslogo.png',80,3,35,16);//Image(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
 ...
 $this->Cell(30,0,$cname,0,1,'C');
        ...
        $this->SetFont('arial','b',7);  
         $this->Cell(30);
        $this->Cell(5,0,"PAN No : $pan_card",0,1,'L');
        ...
        $this->Cell(170,0,strtoupper($caddress),0,1,'C');
...
//$pdf->Image('party.png',180,0,20,10);//Image(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
    ...
    $pdf->SetX(5);
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(21,3,"DI No.",0,0,'L');
    $pdf->Cell(32,3,": ".$di_no,0,0,'L');
    ...
    $pdf->SetX(5);
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(21,3,"GR No. ",0,0,'L');
    $pdf->Cell(33,3,":". $gr_no,0,0,'L');
    
   
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(17,3,"GST No.",0,0,'L');
    $pdf->Cell(31,3,": ".  $cgst_no,0,0,'L');
    ...
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(23,3,"Truck Owner",0,0,'L');
    $pdf->Cell(19,3,":". substr($ownername,0,23),0,1,'L');
    
    $pdf->Ln(2);
     $pdf->SetX(5);    
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(21,3,"GR Date",0,0,'L');
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(33,3,": ".$gr_date,0,0,'L');
    
    
    
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(17,3,"From",0,0,'L');
    $pdf->Cell(62,3,":".$placename,0,0,'L');
    $pdf->Line(58, 34, 137, 34);
  

            
    
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(23,3,"Mobile No",0,0,'L');
    ...
    $pdf->SetX(5);     
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(20,3,"Invoice No",0,0,'L');
    $pdf->Cell(33,3," : ".$invoiceno,0  ,0,'L');
    
    
    $pdf->SetFont('Arial','b',9);
      $pdf->Cell(18,3,"Consignee",0,0,'L');
    ...
    $pdf->SetX(5);  
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(20,3,"Invoice Date",0,0,'L');
    $pdf->Cell(34,3," : ".$gr_date,0,0,'L');
    
     $pdf->SetFont('Arial','b',9);
     $pdf->Cell(17,3,"Mobile",0,0,'L');
    $pdf->Cell(62,3,": ".$consigneemo,0,0,'L'); 
  
    
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(23,3,"Driver No.",0,0,'L');
    $pdf->Cell(60,3," : ".$drivermobile,0,1,'L');
    
    $pdf->Ln(2);
    $pdf->SetX(5);  
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(20,3,"Bilty No",0,0,'L');
    $pdf->Cell(35,3," : ".$chalan,0,0,'L');
        $pdf->SetFont('Arial','b',9);
     $pdf->Cell(16,3,"To",0,0,'L');
    $pdf->Cell(60,3,": ".$destination,0,0,'L'); 
    $pdf->SetFont('Arial','b',9);
    $pdf->Cell(20,3," ",0,0,'L');
    $pdf->Cell(60,3," ",0,0,'L');
...
$pdf->Cell(40,5,number_format($freight,2),'1',0,'R',0);
