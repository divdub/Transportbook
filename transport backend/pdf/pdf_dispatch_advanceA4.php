...
$keyvalue="";
	...
	$sql = mysqli_query($connection,"select * from $tblname where $tblpkey='$dispatch_id'");
...
$owner_id = $cmn->getvalfield($connection, "m_vehicle", "owner_id", "vehicle_id ='$row[vehicle_id]'");
$owner_name = $cmn->getvalfield($connection, "m_vehicle_owner", "owner_name", "owner_id ='$owner_id'");
$mobileno = $cmn->getvalfield($connection, "m_vehicle_owner", "mobileno1", "owner_id ='$owner_id'");
    ...
    $mobile_no2 = $cmn->getvalfield($connection,"m_driver","mobile_no","driver_id='$row[driver_id]'"); 
...
$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(35,4,'Consignor Name','0',0,'L',0);

$pdf->SetFont('Arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(50,4,': '.$consignor_name,'0',0,'L',0);
