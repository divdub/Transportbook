...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "SERVICE DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(20, 7, 'Service Date', 1, 0, 'L', 1);
        $this->Cell(20, 7, 'Service Head', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'Truck No', 1, 0, 'L', 1);
        $this->Cell(40, 7, 'Mechanic/Service Name', 1, 0, 'L', 1);
         $this->Cell(20, 7, 'Amount', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'Next Service Date', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'Next Meter Reading', 1, 1, 'L', 1);

        $this->SetWidths(array(8, 20, 20,30,40,20,30,30));
...
$sql = mysqli_query($connection, "select * from service_entry");
while ($row = mysqli_fetch_array($sql)) {
    ...
    $pdf->Row(array($slno++,$service_date, $head_name, $vehicle_no,$mechanic_name,$row['amount'],$service_datenext,$row['meter_readingnext']));
}
$pdf->Output();
?> 
