...
//       $payment_receive = $cmn->getvalfield($connection,"payment_receive","sum(receive_amt)","consignorid=$consignorid && comp_id=$comp_id && category=4 && session_id=$session_id && receive_date <= '$currdate' and catname='$owner_id'"); 
...
//  $pdf->SetX(20);
   ...
   $pdf->SetFillColor(175, 213, 240);
                                        ...
                                        // $pdf->SetY('36');
                                        $pdf->SetX('205');
                                        $pdf->Cell(60,-10,'Opening Balance : '      .$curr_openingbal,2,0,'L');
                                        $pdf->SetX('205');
...
// 	$pdf->Cell(24,6,'GR/TR NO',1,0,'L',1);
	...
	$pdf->Cell(50,6,'Bill Amount ',1,0,'C',1);	
...
echo  "select * from payroll $crit"; die;
                 $sql = mysqli_query($connection, "select * from payroll $crit");
      ...
      $pdf->SetX(15);
                                            ...
                                            //         $pdf->Cell(50,8, round($amount1,2), 1,0, 'R');
