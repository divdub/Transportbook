...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "CONSIGNOR DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(40, 7, 'CONSIGNOR NAME ', 1, 0, 'L', 1);
...
while ($row_get = mysqli_fetch_array($sql)) {
    ...
    $pdf->Row(array($slno++, $row_get['consignor_name'], $row_get['mobile_no'],$row_get['consignor_address'],$row_get['opn_balnc'],$opn_balnc_date));
}
$pdf->Output();
?> 
