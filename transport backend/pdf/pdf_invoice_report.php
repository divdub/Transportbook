     ...
     function TableHeader()
{
    ...
    $this->Cell(21,6,'Truck No.','1',0,'L',1);  
    $this->Cell(16,6,'L.R.No','1',0,'L',1);
    $this->Cell(17,6,'CI Date','1',0,'L',1);
    $this->Cell(18,6,'CI Number.','1',0,'L',1);
    $this->Cell(20,6,'S.P.No.','1',0,'L',1);	
    $this->Cell(32,6,'Destination','1',0,'L',1);
    $this->Cell(12,6,'Weight','1',0,'L',1);
    $this->Cell(12,6,'Rate','1',0,'L',1);
    $this->Cell(14,6,'Unloading','1',0,'L',1);
    $this->Cell(16,6,'Amount Rs.','1',0,'L',1);
...
$pdf->Line(105,40,105,106);
	...
	$pdf->SetTextColor(0,0,0);
	$pdf->MultiCell(80,5,"$consigneeaddress",0,'L');
	...
	$pdf->TableHeader();
	$pdf->SetWidths(array(8,21,16,17,18,20,32,12,12,14,16,14));
...
while($row2=mysqli_fetch_assoc($sql2)) {
	...
	$pdf->SetFont('Arial','',8);
	$pdf->SetTextColor(0,0,0);
	$pdf->Row(array($sn++,$truckno,$gr_no,$cmn->dateformatindia($gr_date),$invoiceno,$di_no,$deliverat,$totalweight,$comp_rate,$unloading,number_format($total_amt,2),$shortage));
	...
	$pdf->SetFont('Arial','b',8);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(100,6," ",'1',0,'L',0);
	$pdf->Cell(32,6,"Total Weight",'1',0,'R',0);
	$pdf->Cell(12,6,number_format($tot_wt,2),'1',0,'L',0);
	$pdf->Cell(12,6,'Tax Val','1',0,'L',0);
	$pdf->Cell(14,6," ",'1',0,'L',0);
	
// 		$pdf->Cell(20,4,'','1',0,'L',0);
	
	$pdf->Cell(16,6,number_format($nettotal_amt,2),'1',0,'L',0);	
...
I/We have taken registration under the CGST Act, 2017 and have exercised the option to pay tax for services of GTA in relation to transport of goods supplied by us during the Financial Year $session_name under forward charge.";
