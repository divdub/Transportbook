...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "VEHICLE TYPE DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(36, 7, 'Sno', '1', 0, 'L', 1);
        $this->Cell(70, 7, 'VEHICLE TYPE ', 1, 0, 'L', 1);
        $this->Cell(70, 7, 'NUMBER OF WHEELS ', 1, 1, 'L', 1);


        $this->SetWidths(array(36, 70, 70));
...
$sql = mysqli_query($connection, "select * from m_vehicle_type");
while ($row_get = mysqli_fetch_array($sql)) {
    // $pdf->SetX(5);
    $pdf->Row(array($slno++, $row_get['vehicle_type'], $row_get['no_of_wheels']));
}
$pdf->Output();
?> 
