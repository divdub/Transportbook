...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, " INCOME/EXPENSES HEAD DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(47, 7, 'HEAD NAME ', 1, 0, 'L', 1);
         $this->Cell(45, 7, 'HEAD TYPE', 1, 0, 'L', 1);
        $this->Cell(20, 7, 'REMARK', 1, 1, 'L', 1);
        $this->SetX(35);
...
$sql = mysqli_query($connection, "select * from  inc_exp_head");
while ($row_get = mysqli_fetch_array($sql)) {
    $pdf->SetX(35);
    $pdf->Row(array($slno++, $row_get['head_name'],$row_get['head_type'],$row_get['remark']));
}
$pdf->Output();
?> 
