...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, " PLACE DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(47, 7, 'PLACE NAME ', 1, 0, 'L', 1);
         $this->Cell(45, 7, 'STATE NAME', 1, 1, 'L', 1);
       
        $this->SetX(35);
        $this->SetWidths(array(9, 47,45));
...
while ($row_get = mysqli_fetch_array($sql)) {
    $pdf->SetX(35);
    $state_name=$cmn->getvalfield($connection,"m_state","state_name","state_id=$row_get[state_id]");
    $pdf->Row(array($slno++, $row_get['place_name'],$state_name));
}
$pdf->Output();
?> 
