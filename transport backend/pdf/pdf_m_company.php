...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
     $this->ln(6);
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "COMPANY DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(54, 7, 'COMPANY NAME', 1, 0, 'L', 1);
        $this->Cell(30, 7, 'OWNER NAME', 1, 0, 'L', 1);
        $this->Cell(32, 7, 'EMAIL ID', 1, 0, 'L', 1);
        $this->Cell(20, 7, 'CONTACT NO.', 1, 0, 'L', 1);
        $this->Cell(48, 7, 'ADDRESS', 1, 1, 'L', 1);


        $this->SetWidths(array(10, 54,30, 32,20,48));
...
$sql = mysqli_query($connection, "select * from m_company");
while ($row_get = mysqli_fetch_array($sql)) {


  $cname=  $row_get['cname'];
  $ownername=  $row_get['ownername'];


    // $pdf->SetX(5);
    $pdf->Row(array($slno++, $cname, $ownername, $row_get['emailid'],$row_get['mobileno1'],$row_get['caddress']));
}
$pdf->Output();
?> 
