...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "ITEM CATEGORY DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(56, 7, 'Sno', '1', 0, 'L', 1);
        $this->Cell(70, 7, 'CATEGORY NAME  ', 1, 1, 'L', 1);
        

        $this->SetX(35);
        $this->SetWidths(array(56, 70));
...
$sql = mysqli_query($connection, "select * from m_item_category");
while ($row_get = mysqli_fetch_array($sql)) {
    // $pdf->SetX(5);
      $pdf->SetX(35);
    $pdf->Row(array($slno++, $row_get['category_name']));
}
$pdf->Output();
?> 
