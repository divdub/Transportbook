...
$module = "Masters";
$keyvalue = "";
$dadvpayid = trim(addslashes($_GET['dadvpayid']));

$sql = mysqli_query($connection, "select * from $tblname where dadvpayid='$dadvpayid' ");
$row = mysqli_fetch_assoc($sql);

$adv_no  = $row['adv_no'];

$pump_name = $cmn->getvalfield($connection, "m_petrol_pump", "pump_name", "pump_id='$row[pump_id]'");
$vamt = round($row['adv_amt']);
...
$pdf->SetTitle("Advance Payment Receive");
$pdf->AliasNbPages();
$pdf->AddPage('L', 'A5');
...
$pdf->SetTextColor(0, 0, 0);
$pdf->setX(10);
$pdf->Cell(180, 4, 'Advance Payment Receive', '0', 1, 'C', 0);
...
$pdf->SetTextColor(0, 0, 0);
$pdf->setX(3);
$pdf->Cell(51, 8, 'Advance No', '1', 0, 'C', 0);

$pdf->SetFont('Arial', '', 10);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(45, 8, ' ' . $adv_no, '1', 0, 'C', 0);
//$pdf->Ln(2);
$pdf->SetFont('Arial', 'b', 10);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(45, 8, 'Advance Date', '1', 0, 'C', 0);


$pdf->SetFont('Arial', '', 10);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(63, 8, ' ' . dateformatindia($row['adv_date']), '1', 0, 'C', 0);
...
$pdf->SetTextColor(0, 0, 0);
$pdf->setX(3);
$pdf->Cell(51, 8, 'Advance Pay Mode', '1', 0, 'C', 0);
...
$pdf->SetFont('Arial', '', 10);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(63, 8, '' . strtoupper($row['remark']), '1', 0, 'C', 0);
...
$pdf->Ln(3);
$pdf->SetX(10);
$pdf->Cell(187, 6, 'Advance Details', 1, 1, 'C', 0);

$pdf->SetX(10);

$pdf->Cell(120, 6, 'Advance Amount', 1, 0, 'C', 0);
...
$pdf->Cell(40, 10, ucwords(convert_number_to_words($vamt)) . " Rupees Only", 0, 1, 'L', 0);
