...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "EMPLOYEE DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(40, 7, 'DATE OF JOINING', 1, 1, 'L', 1);
...
while ($row_get = mysqli_fetch_array($sql)) {
    // $pdf->SetX(5);
    $date_of_join=dateformatindia($row_get['date_of_join']);
    $pdf->Row(array($slno++, $row_get['employee_name'], $row_get['mobile_no'],$row_get['eaddress'],$row_get['salary'],$date_of_join));
}
$pdf->Output();
?> 
