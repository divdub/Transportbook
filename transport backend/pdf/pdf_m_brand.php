...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "BRAND DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(70, 7, 'BRAND NAME  ', 1, 1, 'L', 1);
...
$sql = mysqli_query($connection, "select * from m_brand");
while ($row_get = mysqli_fetch_array($sql)) {
    // $pdf->SetX(5);
     $pdf->SetX(35);
    $pdf->Row(array($slno++, $row_get['brand_name']));
}
$pdf->Output();
?> 
