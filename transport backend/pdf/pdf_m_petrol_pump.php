...
class PDF_MC_Table extends FPDF
{
    ...
    $this->Cell(2,24,$mobileno1 .",". $mobileno2." ".$emailid, 0, 0, 'C');
        ...
        $this->SetY(28);
        $this->Cell(90);
        $this->Cell(10, 28, "PETROL PUMP DETAILS", 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->Cell(40, 7, 'PUMP NAME ', 1, 0, 'L', 1);
...
$slno = 1;
$sql = mysqli_query($connection, "select * from m_petrol_pump");
while ($row_get = mysqli_fetch_array($sql)) {
    // $pdf->SetX(5);
    $opn_balnc_date=dateformatindia($row_get['opn_balnc_date']);
    $pdf->Row(array($slno++, $row_get['pump_name'], $row_get['head_name'],$row_get['paddress'],$row_get['opn_balnc'],$opn_balnc_date));
}
$pdf->Output();
?> 
