...
if(isset($_GET['di_id']))
{
    $di_id = trim(addslashes($_GET['di_id']));    
}
...
if($di_id !='')
{ 
    $sql_Q= mysqli_query($connection,"select * from x_party_entry where di_id='$di_id'");
   ...
   $chalan=$row['bilty_no'];
    ...
    $consigneename = $cmn->getvalfield($connection,"m_x_consignee","xconsignee_name","xconsignee_id='$consigneeid'"); 
    $consigneeaddress = $cmn->getvalfield($connection,"m_x_consignee","xconsignee_address","xconsignee_id='$consigneeid'"); 
