...
$pdf->Image('../upload/logo/'.$c_logo,6,6,18,11);
	...
	$pdf->Cell(14,6,'D.QTY',1,0,'L',1);
	$pdf->Cell(15,6,'FRT R.',1,0,'L',1);
...
// 	$pdf->Cell(10,6,'MT',1,1,'L',1);
	...
	$pdf->SetWidths(array(8,17,24,17,22,24,32,28,14,15,18,18,15,15,20));
...
while($row2=mysqli_fetch_assoc($sql2)) {
	...
	$pdf->SetFont('Arial','',8);
	$pdf->SetTextColor(0,0,0);
	$pdf->Row(array($sn++,$di_no,$invoiceno,$cmn->dateformatindia($gr_date),$truckno,$gr_no,$consignee_name,$deliverat,$totalweight,$comp_rate,number_format($total_amt,2),number_format($igst,2),number_format($gst1,2),number_format($gst1,2),number_format($gstamt,2)));
	...
	$pdf->Cell(18,4,number_format($nettotal_amt,2),'1',0,'L',0);
		...
		$pdf->Cell(18,4,0,'1',0,'L',0);
	$pdf->Cell(15,4,number_format($tot_gst/2,2),'1',0,'L',0);
	$pdf->Cell(15,4,number_format($tot_gst/2,2),'1',0,'L',0);
	$pdf->Cell(20,4,number_format($tot_gst,2),'1',1,'L',0);
