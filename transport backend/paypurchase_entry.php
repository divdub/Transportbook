...
$tblname = "inv_payment";
$tblpkey = "payment_id";
$pagename = "paypurchase_entry.php";
...
//   echo "update payment set iscomp=1 where type='purchase' && iscomp=0";
	mysqli_query($connection,"update inv_payment set iscomp=1 where type='purchase' && iscomp=0 && compid='$compid' && sessionid='$sessionid'");	
...
?>
	...
	<body onload="showpurchaserecord();">	
...
<input type="hidden" name="purchaseid" id="purchaseid"  style="width:30px;"  value="<?php echo $purchaseid; ?>" autofocus autocomplete="off" />
			...
			<div class="box-content nopadding" id="showpurchaserecord">
						...
						<div class="form-actions">
			          		...
			          		<button type="submit"  onclick="savepurchasevupper()" class="btn btn-primary">Save</button>
