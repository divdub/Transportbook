...
$tblpkey = "dispatch_id";
$pagename = "diesel_adv_report.php";
  ...
  <!-- Edit Modal End-->
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color satblue">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Diesel Advance</h3>
							</div>
	...
	<!-- 									<div class="col-sm-3">
		...
		<?php	$sql = mysqli_query($connection,"Select * from  m_petrol_pump  order by pump_id");
			...
			<!--							</a> &nbsp;-->
					<a href="excel/excel_diesel_advance.php?fromdate=<?php echo $fromdate ?>&todate=<?php echo $todate ?>&vehicle_id=<?php echo $vehicle_id ?>&pump_id=<?php echo $pump_id ?>" class="btn btn-warning" style="float: right">Excel
			...
			<div class="box-content nopadding">
				<table class="table table-hover table-nomargin table-striped table-bordered dataTable dataTable-colvis">
					...
					<th>S.No</th>
						...
						<!--<th>GPS Amt</th>-->
						<th style="display:none;">Consignor Diesel Adv.</th>
                         <th style="display:none;">Consignee Diesel Adv.</th>
						<!--<th>Action</th>-->
					</tr>
					</thead>
					<tbody>
	...
	$vehicle_no=$cmn->getvalfield($connection,"m_vehicle","vehicle_no","vehicle_id=$row[vehicle_id]");
     ...
     $freight_amt=$wt_mt * $own_rate;
					...
					<td><?php echo $sn++;?></td>
						...
						<!--<td><?php echo $row['Diesel_adv']; ?></td>-->
						<!--<td><?php echo $row['other_Diesel_adv']; ?></td>-->
						<td style="display:none;"><?php echo $row['consignor_Diesel_adv']; ?></td>
						<td style="display:none;"><?php echo $row['consignee_Diesel_adv']; ?></td>
					
					</tr>
					
					<?php
				$diesel_adv +=$row['diesel_adv_amt'];
