...
<body class='login'>
	<div class="wrapper">
		<h1>
			<a href="index-2.html">
				<img src="img/logo-big.png" alt="" class='retina-ready' width="59" height="49">Login</a>
		</h1>
		<div class="login-body">
			<h2 style="font-weight: bold">PRITHVI LOGISTICS</h2>
			<form action="" method='get' class='form-validate' id="test">
				<div class="form-group">
					<div class="email controls">
						<input type="text" name='uemail' placeholder="User Name" class='form-control' data-rule-required="true" data-rule-email="true">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
						<select name="select" id="select" class='form-control'>
												...
												<option value="2">PRITHVI LOGISTICS</option>
												<option value="2">Shree Jeet Logistics</option>
