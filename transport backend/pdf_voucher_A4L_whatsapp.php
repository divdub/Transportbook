 ...
 if($_REQUEST['billid'])
  ...
  //   }
    ...
    $cond .=" and category_id='$category_id'";
     ...
     $filename = 'whatsapp/'.$voucher_no.'.pdf';
                                        ...
                                        $pdf->SetFillColor(211, 211, 211);
                                            ...
                                            $pdf->SetFont('Arial','B',8);
                                                    $pdf->Cell(6,8,'S.N',1,0,'C','F');
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(22,8,'Truck No',1,0,'R','F');
                                                   ...
                                                   //  $pdf->Cell(30,8,'Destination',1,0,'L');
                                                    ...
                                                    //  $pdf->Cell(13,8,'Commi.',1,0,'R');
                                                     ...
                                                     $pdf->Cell(10,8,'Rate',1,0,'L','F');
                                                      ...
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,8,'Frt Amt',1,0,'R','F');

                                                    $pdf->SetFont('Arial','B',7);
                                                     $pdf->Cell(12,8,"Comm",1,0,'R','F');

                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'Bank',1,0,'R','F');
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'Rebid',1,0,'C','F');
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,8,'Shrt',1,0,'R','F');
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,8,'TDS',1,0,'R','F');

                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,8,'Di Adv',1,0,'C','F');
      ...
      $pdf->SetX(2);
                                                   ...
                                                   //  $pdf->Cell(30,8,$toplace,1,0,'L');
                                                    ...
                                                    $pdf->Cell(10,8,round($freight_rate),1,0,'R');
                                                     ...
                                                     $pdf->Cell(15,8,round($freight_amt),1,0,'R');
                                                     $pdf->SetFont('Arial','',8);
                                                     ...
                                                     $pdf->SetFont('Arial','',8);
                                                      $pdf->SetTextColor(255, 0, 0);
                                                     $pdf->Cell(12,8,$bank_charge,1,0,'R');
                                                     $pdf->SetFont('Arial','',8);
                                                   
                                                    $pdf->Cell(12,8,$rebidcharge,1,0,'R');
                                                     
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(12,8,$sortamt,1,0,'R');
                                                    ...
                                                    $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(15,8,'-'.round($tds_amt),1,0,'R');
 $pdf->SetTextColor(0, 0, 0);
                                                     $pdf->SetFont('Arial','',8);
                                                     $pdf->Cell(15,8,round($diesel_adv_amt),1,0,'R');
                                                      $pdf->SetFont('Arial','',8);
...
$balamt= $great_total - $rcamt ;
                                        ...
                                        $pdf->SetX(2);
                                                    ...
                                                    //  $pdf->Cell(12,12, $total_wt_mt,1,0,'R');
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(12,12,$total_recweight,1,0,'R');
                                                    //  $pdf->SetFont('Arial','B',8);
                                                    ...
                                                    $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(10,12,'',1,0,'R');
                                                      ...
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,12,round($total_freight),1,0,'R');
                                                     

                                                  $pdf->SetFont('Arial','B',8);
                                             $pdf->Cell(12,12,round($total_commision),1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                         $pdf->SetTextColor(255, 0, 0);
                                                     $pdf->Cell(12,12,$total_bank_charge,1,0,'R');
                                                     $pdf->Cell(12,12,$total_rebidcharge,1,0,'R');
                                                     $pdf->SetFont('Arial','B',8);
                                                     
                                                     $pdf->Cell(12,12,$total_deduct,1,0,'R');

//  $pdf->SetTextColor(0, 0, 0);
                                                    $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,12,'-'.$total_tds,1,0,'R');
                                                     $pdf->SetTextColor(0, 0, 0);
                                                    ...
                                                    //  $pdf->Cell(8,12,'',1,0,'R');
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,12,round($total_desial_adv),1,0,'R');
                                                        $pdf->SetFont('Arial','B',8);
                                                     ...
                                                     $pdf->SetX(2);
                                                      $pdf->SetFont('Arial','B',10);
                                                      $pdf->SetFillColor(175, 213, 240);
                                                     $pdf->Cell(144,12,'Grant Total Amount',1,0,'C','F');

                                                     
                                                     $pdf->Cell(148,12,number_format(round($great_total),2),1,1,'R','F');
