...
if(isset($_POST['submit']))
{
	...
	$form_data = array('cust_name'=>$cust_name,'mobile_no'=>$mobile_no,'email_id'=>$email_id,'hname'=>$hname,'saddress'=>$saddress,'place_id'=>$place_id,'gst_no'=>$gst_no,'pan_no'=>$pan_no,'acc_holder_name'=>$acc_holder_name,'acc_no'=>$acc_no,'ifsc_code'=>$ifsc_code,'bank_name'=>$bank_name,'branch_name'=>$branch_name,'acc_type'=>$acc_type,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"cust_name='$cust_name'");
		if($count == 0)
		{
...
<head>
	...
	<title>CUSTOMER MASTER :: CHAARUVI INFOTECH PVT. LTD.</title>
...
<body>
  ...
  <div class="row" style="padding-top:20px;">
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Customer Master</h3>
							</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Customer Name <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="cust_name" id="cust_name" placeholder="Enter Customer Name" class="form-control" value="<?php echo $cust_name; ?>" required>
												</div>
											</div>
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
                                                <select name="place_id" id="place_id" class='select2-me' style="width:300px;">
     ...
     $state_name=$cmn->getvalfield($connection,"m_state","state_name","state_id=$row[state_id]");
				...
				<a href="pdf/pdf_m_customer.php" class="btn" style="float: right" target="_blank">Pdf 
			...
			<a href="?editid=<?php echo $row['customer_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
							  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['customer_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>
							  	<?php } ?></td>
					</tr>
					<?php } ?>
									</tbody>
