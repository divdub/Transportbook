                                           ...
                                           $lh = 100;
                                            ...
                                            $pdf->Line(2, 20, 208,20);
                                             ...
                                             $pdf->SetX(2.5);
                                               ...
                                               $pdf->Cell(205,7,$consignor_name.' Voucher (Bill Details)',0,0,'C','F');
...
// $panno=$cmn->getvalfield($connection,"m_agent","pan_no","agent_id='$agent_id'");
...
// $panno=$cmn->getvalfield($connection,"m_consignee","pan_no","consignee_id='$consignee_id'");
...
$vname=$cmn->getvalfield($connection,"m_vehicle_owner","owner_name","owner_id='$owner_id'");
    //  $panno=$cmn->getvalfield($connection,"m_vehicle_owner","pan_no","owner_id='$owner_id'");                               }
                                        ...
                                        $pdf->SetFillColor(211, 211, 211);
                                            ...
                                            $pdf->SetFont('Arial','B',8);
                                                    $pdf->Cell(6,8,'S.N',1,0,'C','F');
                                                     ...
                                                     $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(15,8,'DI/LR No',1,0,'L','F');
                                                   ...
                                                   //  $pdf->Cell(30,8,'Destination',1,0,'L');
                                                      $pdf->SetFont('Arial','B',8);
                                                     $pdf->Cell(22,8,'Destination',1,0,'L','F');
...
//  $pdf->SetTextColor(0, 0, 0);
                                                   ...
                                                   //  $pdf->Cell(24,12,'',1,0,'R');
                                                     ...
                                                     $pdf->SetX(2);
                                                      $pdf->SetFont('Arial','B',10);
                                                      $pdf->SetFillColor(175, 213, 240);
                                                     $pdf->Cell(141,12,'Grant Total Amount',1,0,'C','F');

                                                     
                                                     $pdf->Cell(65,12,number_format(round($great_total),2),1,1,'R','F');
