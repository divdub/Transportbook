            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="box box-bordered box-color satblue">
                     <div class="box-title">
                        <h3>
                           <i class="fa fa-list"></i> Incentive Gst Payment
                        </h3>
                     </div>
                     ...
                     <div class="box box-color box-bordered red">
                        <div class="box-title">
                           <h3> <i class="fa fa-table"></i>
                              Incentive Gst Payment Details
                           </h3>
                           <a href="incgstpaypdf.php?fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>" class="btn" target="_blank" style="float: right">Pdf
                        ...
                        <div class="box-content nopadding">
                           <table class="table table-hover table-nomargin table-striped table-bordered dataTable dataTable-colvis">
                              ...
                              <tbody>
                                 ...
                                 <?php
                                 $sn = 1;
                                 // echo "Select * from  $tblname $crit && gst_pay=1 && type='incentive' consignorid=$consignorid && session_id=$session_id order by $tblpkey desc ";die;
                                 $sql = mysqli_query($connection, "Select * from  $tblname $crit && gst_pay=1 && type='incentive' && consignorid=$consignorid && session_id=$session_id order by $tblpkey desc ");
