...
if(isset($_POST['submit']))
{
	...
	$form_data = array('consignee_name'=>$consignee_name,'mobile_no'=>$mobile_no,'email_id'=>$email_id,'consignee_address'=>$consignee_address,'place_id'=>$place_id,'gst_no'=>$gst_no,'pan_no'=>$pan_no,'opn_balnc'=>$opn_balnc,'opn_balnc_date'=>$opn_balnc_date,'acc_holder_name'=>$acc_holder_name,'acc_no'=>$acc_no,'ifsc_code'=>$ifsc_code,'bank_name'=>$bank_name,'branch_name'=>$branch_name,'acc_type'=>$acc_type,'created_date'=>$currentdate);
	 
	if($keyvalue  == 0)
	{
		$count = check_duplicate($connection,$tblname,"consignee_name='$consignee_name'");
		if($count == 0)
		{
...
<head>
	...
	<title>Consignee Master :: Chaaruvi Infotech Pvt. Ltd.</title>
...
<body>
				...
				<div class="row">
					<div class="box box-bordered box-color">
							<div class="box-title">
								...
								<h3>
									<i class="fa fa-bars"></i>Consignee Master</h3>							
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Consignee  Name <span style="color: red">*</span></label>
												<div class="col-sm-8">
													<input type="text" name="consignee_name" id="consignee_name" placeholder="Enter Name" class="form-control" value="<?php echo $consignee_name; ?>" required>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="consignee_address" id="consignee_address" placeholder="Consignee Address" class="form-control" value="<?php echo $consignee_address; ?>" required>
												</div>
											</div>
	...
	<div class="col-sm-4">
			...
			<h3>	<i class="fa fa-table"></i>
					Consignee Master Details</h3>
				<a href="pdf/pdf_m_consignee.php" class="btn" style="float: right" target="_blank">Pdf 
											<i class="fa fa-file-pdf-o"></i>
										</a> &nbsp;
					<a href="excel/excel_consignee.php" class="btn btn-warning" style="float: right">Excel
			...
			<a href="?editid=<?php echo $row['consignee_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
							  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['consignee_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>
							  	<?php } ?>	</td>
					</tr>
					<?php } ?>	
					</tbody>
