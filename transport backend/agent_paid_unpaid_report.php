<?php 
   ...
   $tblname = "tpa_entry";
   $tblpkey = "tpa_id";
   $pagename = "agent_paid_unpaid_report.php";
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="box box-bordered box-color satblue">
                        <div class="box-title">
                           <h3>
                              <i class="fa fa-list"></i>Agent Paid / Unpaid Report
                           </h3>
                        </div>
                                 ...
                                 <tbody>
                                       ...
                                       <?php
                                        ...
                                        //   echo		"Select * from  $tblname  $crit && consignorid=$consignorid && tpcat_id=2 order by $tblpkey desc";
                                          $sql = mysqli_query($connection,"Select * from  $tblname  $crit && consignorid=$consignorid && tpcat_id=1 order by $tblpkey desc");
                                          	  while($row= mysqli_fetch_array($sql)) {
