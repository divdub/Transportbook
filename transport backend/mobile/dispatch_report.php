...
<div class="content-body" >
				...
				<form action="#" method="GET"  class="filter-form">
					...
					<div class="mb-3">
						<label for="form-check-label">Truck No.</label>
						 ...
						 <select name="vehicle_id" id="vehicle_id" class='form-control mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
    ...
    jQuery.ajax({
          ...
          data: "fromdate="+fromdate+"&todate="+todate+"&vehicle_id="+vehicle_id,
          dataType: 'html',
