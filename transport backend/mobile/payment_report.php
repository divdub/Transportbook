...
<div class="content-body" >
				...
				<form action="#" method="GET"  class="filter-form">
					...
					<div class="mb-3">
						<label for="form-check-label">Category</label>
						 ...
						 <select name="tpcat_id" id="tpcat_id" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getname(this.value);getSearch();">
                    ...
                    <div class="mb-3">
						<label for="form-check-label">Voucher Name</label>
						
						 <select name="catname" id="catname" class='form-select select2-me' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
                                             <option value="">      Select  </option>
    ...
    jQuery.ajax({
          ...
          data: "fromdate="+fromdate+"&todate="+todate+"&tpcat_id="+tpcat_id+"&catname="+catname,
          dataType: 'html',
...
function getname(tpcat_id){
    jQuery.ajax({
          ...
          success: function(data){  
            ...
            jQuery('#catname').html(data).trigger('change').trigger('select:select');
       }
          });//ajax close   
}
