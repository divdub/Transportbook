...
<div class="content-body" >
		...
		<div class="row">
			<div class="join-area">
				<form action="#" method="GET"  class="filter-form">
					...
					<div class="mb-3">
						<label for="form-check-label">Other Expense</label>
						
						 <select name="otherid" id="otherid" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
    ...
    jQuery.ajax({
          ...
          data: "fromdate="+fromdate+"&todate="+todate+"&otherid="+otherid,
          dataType: 'html',
