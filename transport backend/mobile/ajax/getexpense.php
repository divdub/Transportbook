...
// printf("SELECT * FROM other_expense_entry $crit LIMIT $initial_page, $limit");
$getQuery = "SELECT * FROM other_expense_entry $crit && consignorid=$consignorid LIMIT $initial_page, $limit";     
...
<div id="report-1">
			<?php 
				...
				//    $sql = mysqli_query($connection, "select * from other_expense_entry $crit order by dispatch_id  desc limit 10 ");
			...
			<div class="col-12 custom-col2">
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-center">
						...
						<div class="col-4 px-3"><p>Expense Date</p>
							<span><?php echo dateformatindia($row['exp_date']); ?></span></div>
							<div class="col-4 px-3"><p>Other Expense</p><span><?php echo $head_name; ?></span></div>
...
$getQuery = "SELECT COUNT(*) FROM other_expense_entry $crit && consignorid=$consignorid ";     
