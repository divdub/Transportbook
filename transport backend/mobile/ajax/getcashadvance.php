				...
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-start">
						...
						<div class="row report-1 d-flex justify-content-between align-items-center">
							...
							<div class="col-4 px-3"><p>Cash Adv Date</p><span><?php echo dateformatindia($row['cash_adv_date']); ?></span></div>
							<div class="col-4 px-3"><p>Cash Adv</p><span><?php echo $row['cash_adv']; ?></span></div>	<div class="col-4 px-3"></span></div>
						</div>
					</div>
				</div>	
				<?php } ?>
