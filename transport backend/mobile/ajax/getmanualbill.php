...
$getQuery = "SELECT * FROM manualinv $crit && consignorid=$consignorid LIMIT $initial_page, $limit";     
			...
			<div class="col-12 custom-col2">
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-center">
						...
						<div class="col-6 px-3"><p>Invoice No</p>
							<span><?php echo $row['invno']; ?></span></div>
							<div class="col-6 px-3"><p>Invoice Date</p><span><?php echo dateformatindia($row['invdate']); ?></span></div>
							<!-- <div class="col-4 px-3"></div> -->
							
						</div>
						<hr class="my-2">
						<div class="row report-1 d-flex justify-content-between align-items-center">
                        <div class="col-6 px-3"><p>Qty</p><span><?php echo $row['qty']; ?></span></div>
							<div class="col-6 px-3"><p>Amount</p><span><?php echo $row['amount']; ?></span></div>
...
$getQuery = "SELECT COUNT(*) FROM manualinv $crit && consignorid=$consignorid ";     
