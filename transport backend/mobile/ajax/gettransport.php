...
$getQuery = "SELECT * FROM payment $crit && commision!=0  && consignorid=$consignorid  LIMIT $initial_page, $limit";     
				...
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-center">
						...
						<div class="col-4 px-3"><p>Qty</p><span><?php echo $qty; ?></span></div>							
							...
							<div class="col-4 px-3"><p>Transport Commision</p><span><?php echo $commision; ?></span></div>
							<div class="col-4 px-3"><p>Final Commision</p><span><?php echo $commision * $wt_mt ; ?></span></div>
						</div>
					</div>
				</div>	
				<?php } ?>
...
$getQuery = "SELECT COUNT(*) FROM payment $crit && commision!=0  && consignorid=$consignorid";     
