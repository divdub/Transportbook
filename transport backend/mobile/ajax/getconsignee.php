...
$getQuery = "SELECT * FROM tpa_entry $crit  && consignorid=$consignorid && tpcat_id=2 LIMIT $initial_page, $limit";     
...
$getQuery = "SELECT COUNT(*) FROM tpa_entry $crit && consignorid=$consignorid && tpcat_id=2";     
