				...
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-center">
						...
						<div class="col-4 px-3"><p>DI/LR No.</p>
							...
							<div class="col-4 px-3"><p>Freight</p><span><?php echo number_format($row['wt_mt'] * $rate,2);?></span></div>							
...
// alert(page);
    ...
    jQuery.ajax({
          ...
          data: "page="+page+"&fromdate="+fromdate+"&todate="+todate+"&selectype="+selectype+"&item_id="+item_id,
          dataType: 'html',
