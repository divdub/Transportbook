...
$getQuery = "SELECT * FROM invoicebilty $crit && consignorid=$consignorid LIMIT $initial_page, $limit";     
			...
			<div class="col-12 custom-col2">
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-start">
						...
						<div class="col-4 px-3"><p>Invoice No</p>
							<span><?php echo $row['invno']; ?></span></div>
							<div class="col-4 px-3"><p>Invoice Date</p><span><?php echo dateformatindia($row['invdate']); ?></span></div>
							<div class="col-4 px-3"><p>Qty </p><span><?php echo $wt_mt; ?></span></div>
							
						</div>
						<hr class="my-2">
						<div class="row report-1 d-flex justify-content-between align-items-center">
							<div class="col-4 px-3"><p>Amount</p><span><?php echo $amount; ?></span></div>
							<div class="col-4 px-3"><p>Action </p><span><a href= "../pdf/pdf_invoice.php?invoiceid=<?php echo $row['invoiceid'];?>" target="_blank" download>Print</a></span></div>
...
$getQuery = "SELECT COUNT(*) FROM invoicebilty $crit && consignorid=$consignorid ";     
