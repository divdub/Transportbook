				...
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-center">
						...
						<div class="col-4 px-3"><p>DI No.</p>
							...
							<div class="col-4 px-3"><p>Bilty Date</p><span style="font-size: 13px;"><?php echo dateformatindia($row['bilty_date']); ?></span></div>
							<div class="col-4 px-3"><p>Truck No. </p><span style="font-size: 13px;"><?php echo $vehicle_no; ?></span></div>
							
						</div>
						<hr class="my-2">
						<div class="row report-1 d-flex justify-content-between align-items-center">
							<div class="col-4 px-3"><p>Destination</p><span style="font-size: 13px;"><?php echo $destination; ?></span></div>
							<div class="col-4 px-3"><p>Weight </p><span style="font-size: 13px;"><?php echo $row['wt_mt']; ?></span></div>
							<div class="col-4 px-3"><p>Comp rate</p><span style="font-size: 13px;"><?php echo $row['comp_rate']; ?></span></div>
						</div>
					</div>
				</div>	
				<?php } ?>
