...
// printf("SELECT * FROM service_entry $crit LIMIT $initial_page, $limit");
$getQuery = "SELECT * FROM service_entry $crit && consignorid=$consignorid  LIMIT $initial_page, $limit";     
...
<div id="report-1">
			<?php 
				...
				//    $sql = mysqli_query($connection, "select * from service_entry $crit order by dispatch_id  desc limit 10 ");
			...
			<div class="col-12 custom-col2">
				<div class="card p-3">
					<div class="row report-1 d-flex justify-content-between align-items-center">
						...
						<div class="col-4 px-3"><p>Service Date</p>
							<span><?php echo dateformatindia($row['service_date']); ?></span></div>
							<div class="col-4 px-3"><p>Service Head</p><span><?php echo $head_name; ?></span></div>
						...
						<div class="row report-1 d-flex justify-content-between align-items-center">
							...
							<div class="col-4 px-3"><p>Next Service Date </p><span><?php echo dateformatindia($row['service_datenext']); ?></span></div>
						</div>
					</div>
				</div>	
				<?php } ?>
...
$getQuery = "SELECT COUNT(*) FROM service_entry $crit && consignorid=$consignorid ";     
