...
<div class="content-body" >
						...
						<label for="form-check-label">Truck No.</label>
						 ...
						 <select name="vehicle_id" id="vehicle_id" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
                                          ...
                                          <script>document.getElementById('vehicle_id').value = '<?php echo $vehicle_id; ?>';</script>
                                                ...
                                                <div class="col-md-6 col-6">
                    <div class="mb-3">
						<label for="form-check-label">Consignor</label>
						
						 <select name="consignor_id" id="consignor_id" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
                                             <option value="">      Select  </option>
    ...
    jQuery.ajax({
          ...
          data: "fromdate="+fromdate+"&todate="+todate+"&vehicle_id="+vehicle_id+"&consignor_id="+consignor_id,
          dataType: 'html',
