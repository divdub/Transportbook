...
$pagename ="Truck Owner Paid/Unpaid Report";
...
<div class="content-body" >
			...
			<div class="join-area">
				<form action="#" method="GET"  class="filter-form">
                    ...
                    <div class="row">
						<div class="col-md-6 col-6">
					<div class="mb-3">
						<label for="form-check-label">Select Type</label>
						
						 <select name="selectype" id="selectype" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
                            ...
                            <option value="0">Unpaid</option>
                                          ...
                                          <script>document.getElementById('selectype').value = '<?php echo $selectype; ?>';</script>
                                                ...
                                                <div class="col-md-6 col-6">
                    <div class="mb-3">
						<label for="form-check-label">Item Name</label>
						
						 <select name="item_id" id="item_id" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
    ...
    jQuery.ajax({
          type: 'POST',
          url: 'ajax/gettruck.php',
          data: "fromdate="+fromdate+"&todate="+todate+"&selectype="+selectype+"&item_id="+item_id,
          dataType: 'html',
