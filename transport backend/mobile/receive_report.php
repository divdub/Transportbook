...
include ('inc/head.php');
 ...
 if ($_GET['is_receive'] == 1) {
	$fromdate = $_GET['fromdate'];
   
	 $is_receive = '1';
$pagename ="Receiving Report";
   } else {
	 $is_receive = '0';
$pagename ="Receiving Pending Report";
   }
...
<div class="content-body" >
					...
					<div class="row">
						...
						<div class="col-md-6 col-6">
							<div class="mb-3">
								...
								<input type="hidden"  name="is_receive" id="is_receive" class="form-control" placeholder="Name" value="<?php echo $is_receive; ?>" >
							</div>
						</div>
					</div>
                    <div class="row">
						...
						<label for="form-check-label">Truck No.</label>
						 ...
						 <select name="vehicle_id" id="vehicle_id" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
                                          ...
                                          <script>document.getElementById('vehicle_id').value = '<?php echo $vehicle_id; ?>';</script>
                                                ...
                                                <div class="col-md-6 col-6">
                    <div class="mb-3">
						<label for="form-check-label">Owner Name</label>
						
						 <select name="owner_id" id="owner_id" class='form-select mySelect' style="width:100%;" aria-label="Default select example" onChange="getSearch();">
                                             <option value="">      Select  </option>
  ...
  var is_receive = document.getElementById("is_receive").value;
    //  alert(is_receive);
    jQuery.ajax({
          type: 'POST',
          url: 'ajax/getreceive.php',
          data: "fromdate="+fromdate+"&todate="+todate+"&vehicle_id="+vehicle_id+"&owner_id="+owner_id+"&is_receive="+is_receive,
          dataType: 'html',
