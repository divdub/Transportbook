...
//  $pdf->SetX(20);
   ...
   $pdf->SetFillColor(175, 213, 240);
                                        ...
                                        $pdf->SetX('2');
                                        $pdf->Cell(293,8,'GST Payment Details',1,0,'C','F');
                                        $pdf->Ln();
...
// 	$pdf->Cell(24,6,'GR/TR NO',1,0,'L',1);
	$pdf->Cell(30,6,'Invoice Date',1,0,'C',1);
...
// 		$pdf->Cell(25,6,'INCOME',1,0,'C',1);
	...
	$pdf->SetFont('Arial','B',9);
				...
				$sql = mysqli_query($connection,"Select * from  invoicebilty $crit && is_pay=1 && consignorid=$consignorid && sessionid=$session_id order by invoiceid desc ");
      ...
      $pdf->SetX(15);
                                                ...
                                                $pdf->Cell(30,8,$row['invno'],1,0,'R');
                                                                                        // $pdf->Cell(24,8, $gr_no, 1,0, 'R');
                                                                                        
                                                    $pdf->Cell(30,8, date('d-m-Y',strtotime($row['invdate'])), 1,0, 'R');
                                                       $pdf->Cell(50,8, $gst_amt, 1,0, 'C');
                                              ...
                                              $pdf->Cell(40,8,$received_gstamt,1,0,'C');

                                               $pdf->Cell(60,8,$gstremark,1,0,'C');
                                           ...
                                           $pdf->SetFillColor(175, 213, 240);
                                             ...
                                             $pdf->Cell(60,12,'',1,1,'R','F');
                                                    ...
                                                    //  $pdf->Cell(90,8,ucwords(convert_number_to_words($total_final))." Rupees Only",2,1,'L');
                                                     $pdf->SetX(10);        $pdf->Cell(45,8,'Total GST Amount  :',2,0,'L');

                                                  
                                                     $pdf->SetX(55);     $pdf->Cell(90,8,ucwords(getinwordsbyindia($tgst_amt))." Rupees Only",2,1,'L');
                                                       $pdf->SetX(10);
                                                     ...
                                                     $pdf->Cell(90,8,ucwords(getinwordsbyindia($treceived_gstamt))." Rupees Only",2,1,'L');
                                                      ...
                                                      $pdf->SetFont('Arial','B',10);
                                                     $pdf->SetX(55);     $pdf->Cell(90,8,ucwords(getinwordsbyindia($tgst_amt - $treceived_gstamt))." Rupees Only",2,1,'L');
