...
$pdf->SetX(10);
$pdf->Cell(45, 8, 'Total Bill Amount  :', 2, 0, 'L');


$pdf->SetX(55);
$pdf->Cell(90, 8, ucwords(getinwordsbyindia($total_incamount)) . "  Only", 2, 1, 'L');
$pdf->SetX(10);
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->SetX(55);
$pdf->Cell(90, 8, ucwords(getinwordsbyindia(round($totbalamt))) . "  Only", 2, 1, 'L');
