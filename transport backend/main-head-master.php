...
<head>
	...
	<title>HEAD MASTER :: CHAARUVI INFOTECH PVT. LTD.</title>
 ...
 <div class="row" style="padding-top:20px;">
	...
	<div class="row">
		...
		<!--					<i class="fa fa-file-excel-o"></i></a>						-->
			...
			<a href="?editid=<?php echo $row['head_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
						  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['head_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>		<?php } ?>	
