				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Loding Report</h3>
							</div>
							<div class="box-content nopadding">
								<form action="#" method="POST" class='form-horizontal form-column form-bordered'>
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Form Date</label>
												<div class="col-sm-8">
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Vechicle No.</label>
												<div class="col-sm-8">
                                                <select name="select" id="select" class='form-control'>
												<option value="1"></option>
												<option value="2"></option>
                                        ...
                                        <div class="col-sm-4">
											<div class="form-group">
												<label for="textfield" class="control-label col-sm-4">Vechicle Owner Name</label>
												<div class="col-sm-8">
                                                <select name="select" id="select" class='form-control'>
												<option value="1"></option>
												<option value="2"></option>
								...
								<table class="table table-hover table-nomargin">
									...
									<tbody>
										<tr>
											...
											<td>Trident</td>
											<td>Trident</td>
											<td class='hidden-350' style="display:flex">
