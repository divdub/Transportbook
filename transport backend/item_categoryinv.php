...
$tblname = "m_iteminv_category";
$tblpkey = "iteminv_category_id";
$pagename = "item_categoryinv.php";
  ...
  <div class="row" style="padding-top:20px;">
	...
	<a href="excel/excel_category.php" class="btn btn-warning" style="float: right">Excel
				<i class="fa fa-file-excel-o"></i></a>
						...
						<a href="?editid=<?php echo $row['iteminv_category_id']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
					  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['iteminv_category_id']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a>		<?php } ?>
										</tr>
										<?php } ?>
									</tbody>
								</table>
