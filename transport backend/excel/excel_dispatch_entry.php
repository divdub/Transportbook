...
<table>
									<thead>
									       <tr><th colspan="32" style="font-weight:bold;font-size:24px;"> <?php echo ucfirst($cname); ?> DISPATCH REPORT </th></tr>
										<tr>
							<th>S.No</th>
						<th>DI/LR No.</th>
						<th>Bilty No.</th>
...
$difference=$row['checkbox'];
				$freight_amt=$wt_mt * $own_rate;
				       ...
				       $invoiceid = $row['invoiceid'];
								...
								$payee_name = $cmn->getvalfield($connection,"payment","payee_name","voucher_id='$voucher_id' && comp_id=$comp_id && session_id=$session_id");
								if($difference=='1'){ 
								    $dispatchid=$row['dispatch_id'];
										   ...
										   ?>
					<tr  <?php if($difference=='1') { ?> style="background-color:#ADD8E6;" <? } ?>>
						<td><?php echo $sn++;?></td>
				   ...
				   <td <?php if($is_complete=='0'){ ?> style="color:red;" <?php
				   
				   } else { ?>style="color:green;" <?php } ?>><?php echo $status;?></td> 
				   <td><?php echo $payee_name;?></td> 
						  <td><?php echo $invno; ?></td>
				   <td><?php echo $invdate; ?></td> 
						<td><?php  if($difference=='1'){
						echo "YES"; } else{
						echo "NO" ;} ; ?></td>
...
$totcash_adv +=$row['cash_adv'];
									...
									<tr>
										<td colspan="12"  style="font-weight:bold;background-color:blue;color: white;text-align: center;font-size: 24px;">Total</td>
...
<td  colspan="7" style="font-weight:bold;background-color:blue;color: white;"></td>
...
<td  style="font-weight:bold;background-color:blue;color: white;"> <?php echo $tottamt; ?></td>
					...
					<td colspan="34" style="background-color:gray;text-align:center;font-weight:bold;font-size:24px;"> TOTAL FREIGHT AMOUNT	: <?php echo $net; ?> </td>
										</tr>
									</tbody>
									<tfoot>
									    	<tr>
					...
					<td colspan="34" style="background-color:gray;text-align:center;font-weight:bold;font-size:24px;"> TOTAL FREIGHT AMOUNT	: <?php echo ucwords(getinwordsbyindia($net)); ?> </td>
										</tr>
									</tfoot>
								</table>
<script>
