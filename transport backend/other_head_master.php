...
$tblpkey = "otherid";
$pagename = "other_head_master.php";
...
if(isset($_POST['submit']))
{
	 ...
	 $remark=$_POST['remark'];
	$form_data = array('head_name'=>$head_name,'remark'=>$remark,'created_date'=>$currentdate);
	...
	{
	$form_data = array('head_name'=>$head_name,'remark'=>$remark,'updated_date'=>$currentdate);
...
<head>
  ...
  :: CHAARUVI INFOTECH PVT. LTD.</title>
...
<body>
                ...
                <div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Other Expense Master</h3>
							</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="remark" id="remark" placeholder="Enter Description" class="form-control" value="<?php echo $remark; ?>">
												</div>
											</div>
 ...
 Details
		...
		<!--					<i class="fa fa-file-excel-o"></i></a>						-->
			...
			<a href="?editid=<?php echo $row['otherid']; ?>" class="btn btn-primary" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
						  <a href="<?php echo $pagename ?>" class="btn btn-danger" onClick="funDel(<?php echo $row['otherid']; ?>)" rel="tooltip" title="Delete"><i class="fa fa-times"></i></a> 	<?php } ?>	
